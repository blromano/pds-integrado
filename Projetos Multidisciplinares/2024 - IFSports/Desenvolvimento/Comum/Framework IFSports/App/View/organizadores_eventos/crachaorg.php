...
<head>
    ...
    <style>
        ...
        .logo img {
            ...
            display: block;
            margin: 0 auto 10px;
            /* Centraliza a logo e adiciona margem inferior */
        }
...
<body>
    <div class="badge-container">
        ...
        <div class="photo">
            <!--<img src="/resources/imagens/<?php //echo $this->getView()->organizador->__get('ORE_FOTO'); ?> " alt="Foto do Funcionário"> -->
            <img src="/resources/images/fotos-alunos/anafelix.png" alt="Foto do Funcionário">
        </div>
        <div class="name-background">
            <div class="name"><?php
                                echo $this->getView()->organizador->__get('ORE_NOME'); ?></div>
        </div>

        CPF: <?php echo $this->getView()->organizador->__get('ORE_CPF'); ?> <br>
        Data de nascimento: <?php echo $this->getView()->organizador->__get('ORE_DATA_NASCIMENTO'); ?> <br>
        <!-- Telefone:    <?php echo $this->getView()->organizador->__get('ORE_TELEFONE'); ?> <br> -->
        Campus: <?php echo $this->getView()->organizador->__get('CAM_NOME'); ?> <br>
        Evento: <?php echo $this->getView()->organizador->__get('EVO_NOME'); ?>
