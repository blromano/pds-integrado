<div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">CADASTRAR ORGANIZADOR</h4>
                  <p class="card-description">
                    
                  </p>
                  <!-- NÃO ESQUECER DE ALTERAR O ID PARA O NOME CORRETO-->
                  <form class="forms-sample" action="/cadastrarorg/cadastrarorg">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Nome Social">
                    </div>
                    <!-- NÃO ESQUECER DE CRIAR O CÓDIGO PARA DATA DE NASCIMENTO NO FORMULÁRIO -->

                    <div class="form-group">
                      <label for="exampleInputName1">CPF</label>
                      <input type="cpf" class="form-control cpf" id="exampleInputName1" placeholder="CPF" data-mask="000.000.000-00">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputName1">RG</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="RG">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Prontuário">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputCity1">Campus</label>
                      <input type="text" class="form-control" id="exampleInputCity1" placeholder="Campus">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="exampleInputSenha4" placeholder="Definir Senha">
                    </div>
                    <!-- NÃO ESQUECER DE ALTERAR O ID PARA O NOME CORRETO-->
                    <div class="form-group">
                      <label for="exampleInputSenha5">Confirmar Senha</label>
                      <input type="password" class="form-control" id="exampleInputSenha5" placeholder="Confirmar Senha">
                    </div>
