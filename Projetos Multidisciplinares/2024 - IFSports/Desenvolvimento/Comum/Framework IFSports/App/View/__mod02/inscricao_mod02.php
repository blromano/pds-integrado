...
function alertarEnvio() {
    ...
    window.location.href = "/listar_eventos";
}
    ...
    <form id="uploadForm" enctype="multipart/form-data">
        <tbody>
            <tr>
                ...
                <td>
                    <center><input type="file" name="file" required style="display:none"><label class="btn btn-dark botao">Escolher Arquivo</label></input></center>
                </td>
            </tr>
            <tr>
                <td>
