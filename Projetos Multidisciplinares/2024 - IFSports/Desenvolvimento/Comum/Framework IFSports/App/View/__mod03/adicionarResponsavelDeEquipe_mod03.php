...
<body>
  <div class="card">
    <div class="tools">
      ...
      <p class="adicionar"> Adicionar Responsável</p>
    </div>
    ...
    <div class="card__content">
      ...
      <div class="form-group">
        <div class="card-body">
          <form action= "/ResponsavelDeEquipe/inserir" method="POST" class="form-sample">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Nome Completo</label>
                  <div class="col-sm-9">
                    <input type="text" id="RES_NOME" name= "RES_NOME" class="form-control" placeholder="Ex: Ana Carolina Moreira Ferreira">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="RES_EMAIL" name= "RES_EMAIL" class="form-control" placeholder="Ex: maria.silva@aluno.ifsp.edu.br">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="RES_PRONTUARIO" name= "RES_PRONTUARIO" class="form-control" placeholder="Ex: BVXXXXXX">
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="RES_CPF" name= "RES_CPF" class="form-control" placeholder="Ex: XXX.XXX.XXX-XX">
                  </div>
                </div>
              </div>
            </div>
            ...
            <input type="submit" class="btn btn-primary btn-icon-text" value="Salvar">
          </form>
        </div>
      </div>
      </p>
