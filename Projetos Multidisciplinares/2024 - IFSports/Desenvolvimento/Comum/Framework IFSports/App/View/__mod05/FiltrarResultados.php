...
<head>
    ...
    <style>
        ...
        <td>Vôlei</td>
        <td>
         <a  href="/eventos/VisualizarResultadosjogos"><button class="visualizar"  type="button" >Visualizar</button></a>             
         <a  href="/eventos/EditarResultados"><button class="editar"  type="button" >Editar</button></a>
         </td>
         </td>
         </tr>
