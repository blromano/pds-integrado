...
<body>
    <div class="badge-container">
        ...
        <div class="photo">
            <img src="/resources/images/foto-alunos/anabiazoto.png<?php echo $this->getView()->secretario->__get('SCE_FOTO'); ?> " alt="Foto do Funcionário">
        </div>
        <div class="name-background">
            <div class="name"><?php
                                echo $this->getView()->secretario->__get('SCE_NOME'); ?></div>
        </div>

        CPF: <?php echo $this->getView()->secretario->__get('SCE_CPF'); ?> <br>
        Data de nascimento: <?php echo $this->getView()->secretario->__get('SCE_DATA_NASCIMENTO'); ?> <br>
        <!-- Telefone:    <?php echo $this->getView()->secretario->__get('SCE_TELEFONE'); ?> <br> -->
        Campus: <?php echo $this->getView()->secretario->__get('CAM_NOME'); ?> <br>
        Evento: <?php echo $this->getView()->secretario->__get('EVO_NOME'); ?>
