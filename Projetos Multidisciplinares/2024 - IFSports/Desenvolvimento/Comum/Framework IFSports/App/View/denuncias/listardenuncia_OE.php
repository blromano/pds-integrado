...
<body>
    <div class="card-body">
        ...
        <div class="container mt-5">
            <center>
            <p class="titulo">PAINEL DE DENÚNCIAS - ORGANIZADOR DE EVENTOS</p>
            </center>
            ...
            <div class="table-responsive pt-3">
                <table class="table table-bordered">
                    <div class="search-form">
                        <form action="/denuncias/filtrar" method="GET" class="d-flex">
    ...
    <script>
        function visualizarDenuncia(id, titulo, descricao, status) {
            ...
            <select id="novoStatus" class="form-select">
                <option value="DEFERIDA" ${status === 'DEFERIDA' ? 'selected' : ''}>DEFERIDA</option>
                <option value="INDEFERIDA" ${status === 'INDEFERIDA' ? 'selected' : ''}>INDEFERIDA</option>
                <option value="PENDENTE" ${status === 'PENDENTE' ? 'selected' : ''}>PENDENTE</option>
                <option value="INATIVADA" ${status === 'INATIVADA' ? 'selected' : ''}>INATIVADA</option>
