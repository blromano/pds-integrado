...
<div class="col-lg-12 grid-margin stretch-card">
              ...
              <div>
                  <div class="col-lg-7 title_evento"> <?php echo $this->getView()->title; ?> </div>
              </div>
              <br clear="all">
                     ...
                     <table id="tabela" class="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="centralize">Inscrever Responsável</th>
                      ...
                      <tbody>
                        <?php foreach($this->getView()->eventos as $eventoModel){ ?>
                          <tr>
                            ...
                            <td>
                                  <a href="/dashboard/responsaveis_equipe_evento_modalidade/atribuirmodalidaderesponsavel?EVO_ID=<?php echo $eventoModel->__get('EVO_ID'); ?>&RES_ID=<?php echo $_GET['RES_ID']; ?>" ><button type="button" class="btn btn-inverse-primary">Inscrever Responsável</button></a>
                            </td>                   
                            <td>
