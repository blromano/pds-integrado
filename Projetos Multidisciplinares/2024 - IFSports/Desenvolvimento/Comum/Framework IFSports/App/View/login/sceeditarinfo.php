                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="SCE_NOME_SOCIAL" name="SCE_NOME_SOCIAL" class="form-control" type="text" value="<?php echo $this->getView()->secretario->__get('SCE_NOME_SOCIAL'); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="SCE_TELEFONE" name="SCE_TELEFONE" placeholder="" class="form-control" type="text" value="<?php echo $this->getView()->secretario->__get('SCE_TELEFONE'); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="SCE_DATA_NASCIMENTO" name="SCE_DATA_NASCIMENTO" placeholder="" class="form-control" type="text" value="<?php echo $this->getView()->secretario->__get('SCE_DATA_NASCIMENTO'); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="SCE_CEP" name="SCE_CEP" placeholder="" class="form-control" type="text" value="<?php echo $this->getView()->secretario->__get('SCE_CEP'); ?>">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="SCE_BAIRRO" name="SCE_BAIRRO" placeholder="" class="form-control" type="text" value="<?php echo $this->getView()->secretario->__get('SCE_BAIRRO'); ?>">
                                    <button class="edit-button">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="SCE_RUA" name="SCE_RUA" placeholder="" class="form-control" type="text" value="<?php echo $this->getView()->secretario->__get('SCE_RUA'); ?>">
                                    <button class="edit-button">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                </div>
