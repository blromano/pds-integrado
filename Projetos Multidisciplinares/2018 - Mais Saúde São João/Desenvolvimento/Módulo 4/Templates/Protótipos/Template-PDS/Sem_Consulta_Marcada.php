...
<div class="container" role="main" style="height: 100%;width: 100%; padding:5%; float:left; min-height: 100%" >
            <br/>
            <br/>
            <div id="quadro" class="col-md-4 col-md-offset-4" style=" padding-bottom:  200px; ">              
                Parece que você não tem uma consulta marcada. 
                
                
            </div>
                  <div class="col-md-1 " style="padding-top:30px; margin-left: 15px; ">
                    <button class="btn btn-danger" style="width: 150px; font-size: 14px; " >Marcar consulta</button>
                </div> 
