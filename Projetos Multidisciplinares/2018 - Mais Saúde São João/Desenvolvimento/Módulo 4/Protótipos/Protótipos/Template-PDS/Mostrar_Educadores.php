...
<body>
        ...
        <div class="card border-dark mb-3 text-center"" style="width: 10rem;float: left">
                    ...
                    <div class="card-body">
                    <h5 class="card-title">Rogerinho</h5>
                    </div>
        </div>
        <div class="card border-dark mb-3 text-center"" style="width: 10rem;float: left;margin-left: 20px">
                    <a data-toggle="modal" data-target="#exampleModal"><img class="card-img-top" src="http://blogpilates.com.br/wp-content/uploads/2016/03/PILATES-EDUCADORES-FISICOS.jpg" alt="Card image cap"></a>
                    <div class="card-body">
                    <h5 class="card-title">Sergitos</h5>
                    </div>
        </div>
