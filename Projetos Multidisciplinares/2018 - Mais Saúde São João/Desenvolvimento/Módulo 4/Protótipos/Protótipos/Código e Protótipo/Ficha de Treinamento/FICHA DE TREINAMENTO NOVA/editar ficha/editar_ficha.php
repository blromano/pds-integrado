            ...
            <div class="container" role="main" style="height: 100%;width: 100%;  min-height: 100%;">
                ...
                <div class="tabcontent p-md-8">  <br>
                    ...
                    <div class="offset-md-3  form-group row">
                        ...
                        <div class="col-md-2  col"><label>Termino</label><input type="date" class="form-control " name="dataTermino" min="2018-06-19"></div>
                    </div>
                    <br>
                    <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-success btn-lg ">Adicionar treino</button>
                    </div>
                    </div>
                    <br><br>
                    <div id="treino">
                        <div>
                            <div class="card-header">
                                <a class="card-link " data-toggle="collapse" href="#collapseOne1">
                                   ...
                                   <label class="btn btn-danger btn-lg offset-md-9">Excluir treino</label>
                            </div>
                                             ...
                                             <div id="collapseOne" class="collapse" data-parent="#accordion"><br>
                                               ...
                                               <div class="offset-md-1 card-body">
                                                   ...
                                                   <textarea rows="3" cols="35" placeholder="Observação"></textarea>
                                                     <label class="btn btn-danger btn-lg offset-md-4">Excluir Exercicio</label>
                                                </div>
                                             </div>
                                           </div>
                                       </div>
                        ...
                        <div style="text-align: center;">
                            ...
                            <button type="button" class="btn btn-danger btn-lg" onclick="finalizar()">Confirmar dados</button>
