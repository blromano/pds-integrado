...
<div class="container">
  <h2>Tabela de Planos Alimentares</h2>            
  <table class="table">
    <thead>
      <tr>
        <th>Alimento</th>
    ...
    <tbody>
      ...
      <a href="index.html" class="btn btn-primary">Editar</a>
    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" style="margin-top: 4%;">
