  ...
  var display = document.getElementById(elemento).style.display;
    if(display == "none"){
        ...
        <div class="container" role="main" style="height: 100%;width: 100%; padding:5%; float:left; min-height: 100%" >
            ...
            <h1 style='color:#104999'>Atualizar</h1>
            </div>
            <form action="diario_bordo.php" method="post">
                <label for="peso">Atualizar Peso:</label>
                <input  type="text" name="peso" class="form-control-static" placeholder="Digite seu Peso">
                <br>
                <label for="altura">Atualizar Altura:</label>
                <input  type="text" name="altura" class="form-control-static" placeholder="Digite sua Altura">
                <br>
                <label for="email">Atualizar Idade:</label>
                <input  type="text" name="idade" class="form-control-static" placeholder="Digite sua Idade">
                <br>
