   ...
   ================================================== -->
    ...
    <body style="background-color:white">
        ...
        <div class="container" role="main" style="height: 100%;width: 100%; padding:5%; float:left; min-height: 100%" >
                        ...
                        <h2 class="h01">Editar Patologia</h2>
                        
                        <form>
                        
                        <div class="form-group">
      <label for="nome">Nome da patologia:</label>
      <input type="text" class="form-control" id="nome" style="width: 500px">
    </div>

    
                            <button type="button" class="btn btn-success">Alterar dados</button>
