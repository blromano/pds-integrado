...
<html lang="pt-br">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#apagar_Adm">Visualizar Perfil</button>
  ...
  <button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#apagar_Adm">Visualizar Perfil</button>
            ...
            <div class="modal fade" id="apagar_Adm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Patologias do usuário</h5>
       
      </div>
      <div class="modal-body">
       Patologias do usuário : Diabetes, hipertensão....
       <br>
       Medicações contínuas: Insulina.
      </div>
