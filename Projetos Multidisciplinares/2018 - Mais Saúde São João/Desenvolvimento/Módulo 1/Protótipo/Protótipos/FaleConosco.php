...
<html lang="pt-br">
            ...
            <div class="row">
                ...
                <nav id="main-nav-wrap">
                    <ul class="main-navigation">
                        ...
                        <li><a class="smoothscroll"  href="FaleConosco.php" title="">Fale conosco</a></li>
  ...
  <form>
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control" id="pwd" style="width: 800px" placeholder="fulano@subdominio.com">
    </div>
      
      <div class="form-group">
  <label for="sel1">Tipo de mensagem:</label>
  <select class="form-control" id="sel1" style="width: 200px">
    ...
    <div class="form-group">
      ...
      <textarea cols="100" class="form-control" rows="5" id="comment" style="width: 800px"></textarea>
    </div>
