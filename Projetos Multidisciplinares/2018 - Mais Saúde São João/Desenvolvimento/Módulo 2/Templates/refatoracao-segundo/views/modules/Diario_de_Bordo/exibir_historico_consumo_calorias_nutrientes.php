                ...
                <div class="container text-center p-5">
                    <div class="atualizar_diario">
                        <div class="page-header esquerda">
                            <h1 class="total_refeicao">Histórico de Consumo de Calorias e Nutrientes</h1>
                            <hr>
                        </div>
                        ...
                        <hr>
                        <h1 class="total_refeicao">Histórico de Consumo de Calorias</h1>
                        ...
                        <hr/>
                        <h1 class="total_refeicao">Histórico de Consumo de Nutrientes</h1>
                        <div class="table-responsive">
                            <table class="table table-striped" >
                                <thead>
                                    <tr>
