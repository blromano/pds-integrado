                        ...
                        <form method="POST" action="adc.php">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="foto" required autofocus>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputCpf">CNPJ da empresa</label>
                                    <input type="text" class="form-control" name="cnpj"  value="" required>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" name="desc_empresa" rows="10" required>
