                ...
                <div class="row">
                    <div class="col">
                        <div class="containerLg ">
                            <a href="login.php" class="btn-lg btn-block btn-primary active " role="button" aria-pressed="true">Login</a>
                            <br />
                            <a href="adicionar.php" class="btn-lg btn-block btn-primary active" role="button" aria-pressed="true">Cadastro</a>
                        </div>
                    </div>
                </div>
            </div>
