<div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">Relatórios Atividades Recreativas</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-table"></i>
               Tabela de Dados das Atividades Recreativas Realizadas pelo idoso</div>
          <div class="card-body">
              ...
              <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
               ...
               <!-- Exemplo de como o menu deve ficar-->
                ...
                <tr role="row" class="odd">
                    <td class="sorting_1">14/05/2019</td>
                    <td>Sessão de Alongamento</td>
                    <td>O idoso conseguiu exercer com sucesso todos os exercícios de alongamento!</td>
