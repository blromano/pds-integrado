<div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Gerenciamento de Patologias</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-2">
                  <a href="/md5/cadastrarPI" style="width:100%" class="btn btn-primary btn-sm">Inserir Patologia</a>
                </div>
              </div>
            </div> 
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th>Data/Hora da Incidência</th>
                    <th>Patologia</th>
                    <th>Grau</th>
                    <th>Observações Iniciais</th>
                    <th>Ações</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td><a href="/md5/historicoEvolucao" class="btn btn-primary btn-sm">Evolução</a></td></td>
                  </tr>
                </tbody>
              </table>
            </div>
