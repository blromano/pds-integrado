<div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Registro de Evolução de Patologia</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
                <div class="col-10">
                  <i class="fas fa-file-medical"></i>
                  Histórico de Evolução de Patologia
                </div>
                <div class="col-2">
                  <a href="/md5/cadastrarEvolucao" style="width:100%" class="btn btn-primary btn-sm">Inserir Atualização</a>
                </div>
              </div>
            </div> 
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <tr>
                    <td>11/05/2019 - 09:35:00</td>
                    <td>Virose</td>
                    <td>Médio</td>
                    <td>O Paciente passou mal durante à noite e vomitou 2 vezes.</td>
                  </tr>
                </tbody>
              </table>
            </div>
