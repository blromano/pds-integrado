<div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Editar Prescrição</li>
        </ol>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-4 mr-auto">
                      ...
                      <input type="text" class="form-control" name="medicamento" id="medicamento" value="Dipirona">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    <div class="col-4 ml-auto">
                      ...
                      <input type="text" class="form-control" name="posologia" id="posologia" value="4 comprimidos/dia (6 em 6 horas)">
                    </div>
                    <div class="col-4 mr-auto">
                      <label for="Login">Validade da Prescrição</label>
                      <input type="text" class="form-control" name="validade" id="validade" value="6 meses">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    <div class="col-8 mx-auto">
                      ...
                      <textarea class="form-control" rows="5" name="observacoes" id="observacoes" value="-"></textarea> 
                    </div>
                  </div>
                </div>
                <div style="text-align: center;">
