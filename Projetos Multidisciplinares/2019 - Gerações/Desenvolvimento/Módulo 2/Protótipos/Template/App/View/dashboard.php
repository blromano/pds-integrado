    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <a class="dropdown-item" href="meuidoso">Meu Idoso</a>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav bg-dark">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <a class="dropdown-item" href="/md2/listar">Idosos</a>
          <a class="dropdown-item" href="/md2/cadastroidoso">Cadastrar</a>
        </div>
      </li>
       <li class="nav-item dropdown active">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
       ...
       <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <a class="dropdown-item" href="/md2/idosoedfisico">Patologias</a>
          <a class="dropdown-item" href="/md2/medicamentos">Medicamentos</a>
          <a class="dropdown-item" href="">Vacinas</a>
          <a class="dropdown-item" href="/md2/registroalergia">Alergias</a>
          ...
          <a class="dropdown-item" href="/md2/listar_restricoes">Restrições alimentares</a>
          <a class="dropdown-item" href="/md2/analiseclinica">Análise Clínica</a>
        </div>
      </li>
      <li class="nav-item dropdown active">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
