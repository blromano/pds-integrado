        ...
        <section id="contact">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <label>Deseja salvar as alterações realizadas? </label>                       
                    </div>
                    <div class="modal-footer">
...
<div class="modal fade" id="modal-cancelar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-body">
                        <label>Você realmente deseja excluir as alterações ?</label>                       
                    </div>
                    <div class="modal-footer">
                    ...
                    <div>
                       <input  type="submit" role="button" value="Salvar" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#modal-salvar"></input>
                       <input  type="submit" role="button" value="Cancelar" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#modal-cancelar"></input>
                    </div>
