...
$ (document).ready(function() {
    ...
    function getIdAlerta(){
        $.ajax({
            url: 'class/alertas/critico/getLastId.php',
    ...
    function verificarAlerta(){
        $.ajax({
            url: 'class/alertas/critico/verificarAlerta.php',
            type: 'post',
            dataType: 'json',
            data: {
                idUser: idUser,
            ...
            success: function(data){
                if(data != false){
                    ...
                    if(data.fonte == "user"){
                        ...
                        '<p>Hora: ' + data.hora+ '</p>' +
                        '<p>Para mais informações <a style="font-weight: bold; color: white" href="">CLIQUE AQUI!</a></p>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
