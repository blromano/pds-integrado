...
require_once '../../../../modelo/mod05/alertaCritico.php';
require_once '../../../../modelo/mod05/alertaUser.php';
require_once '../../../../modelo/mod05/paramAlertas.php';
require_once '../../../../modelo/mod05/medicao.php';
...
private function prepareEmail($alertaCritico, $param, $tipoAlerta, $cor){
  try {
    ...
    foreach ($rows as $alerta) {
      ...
      if(empty($valorMin))   
        $conteudoEmail = str_replace("PARAM_MINSIMBOLO_MEDICAO - PARAM_MAX", "ACIMA DE " . $valorMax, $conteudoEmail);
      else if(empty($valorMax)){
        echo "asdfhasujsda";
        $conteudoEmail = str_replace("PARAM_MINSIMBOLO_MEDICAO - PARAM_MAX", "ABAIXO DE " . $valorMin, $conteudoEmail);
      }
      else{
        echo "teste: " . empty($valorMax);
