...
include_once "../../modelo/mod01/UsuarioEspecialista.php";
include_once "../../dao/mod01/UsuarioEspecialistaDAO.php";
include_once "../../modelo/mod01/UsuarioInstituicao.php";
include_once "../../dao/mod01/UsuarioInstituicaoDAO.php";
include_once "../../modelo/mod01/NivelAcesso.php";
include_once "../../dao/mod01/NivelAcessoDAO.php";
...
//Pegar o nivel de acesso do Usuario(1 - comum, 2 - instituição, 3 -  especialista) e formata de acordo com o paramentro do banco
    $nivel = $_POST['nivel'];
...
//cadastro do usuario
    ...
    $usuario->setNivelAcesso($idNivel);
...
//caso o nomes de pastas ou a disposção das mesmas mudarem, deve-se modificar o link
    $txtMensagem = "<h3>Bem Vindo ao INDRA</h3><br><br>"
            ...
            . "http://localhost/integracao/class/mod01/ConfirmarCadastro.php?cod=$cod<br><br>"
...
//$usuarioInstituicao->naoexiste();
    ...
    if (smtpmailer($txtEmail, 'testeindrapds@gmail.com', $txtNome, $txtAssunto, $corpoMensagem)) {
        ...
        Header("location: ../../indra/mod01/sucesso.php"); // Redireciona para uma página de Sucesso.
    }
    if (!empty($error))
        echo $error;
}else {
