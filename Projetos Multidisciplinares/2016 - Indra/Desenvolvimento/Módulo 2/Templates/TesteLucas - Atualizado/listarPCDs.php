    ...
    <body id="page-top" class="index">
		...
		<!--MODAL EXCLUIR-->
            ...
            <div class="modal fade" id="cadastra-pcd-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
					<form class="formPCD"  action="class/cadastrarPCD.php" method="POST" >
						<div class="modal-header">
            ...
            <div class="modal fade" id="editar-pcd-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
					<form class="formPCD" action="class/editarPCD.php" method="POST" >
						<div class="modal-header">
                             <h3>Editar PCD</h3>
                        </div>
                        <div class="modal-body">
                    ...
                    <div class="form-group">
											<label>Cidade em que a PCD estará localizada</label>
										<div>
											<select name = "cidade1" class="form-control select-cidade">
												<option value="">  </option>
												<option value="São João da Boa Vista">São João da Boa Vista</option>
												<option value="Aguaí">Aguaí</option>
												<option value="Águas da Prata">Águas da Prata</option>
                    ...
                    <div class="form-group">
											<label>Estado em que a PCD estará localizada</label>
										<div>
											<select name = "estado1" class="form-control select-estado">
												<option value="">  </option>
												<option value="SP">SP</option>
												<option value="MG">MG</option>
												<option value="RJ">RJ</option>
					...
					<div class="form-group " >
                        <label>Descrição:</label>
                        <input name="descricao1" type="text" class="form-control valor-descricao" placeholder="Descrição" required>
                    </div>
					<div class="form-group ">
                        <label>Localização (Latitude):</label>
                        <input name = "latitude1" type="text" class="form-control valor-latitude"placeholder="Latitude">
                    </div>
					<div class="form-group ">
                        <label>Localização (Longitude):</label>
                        <input name= "longitude1" type="text" class="form-control valor-longitude"placeholder="Longitude">
                    </div>
