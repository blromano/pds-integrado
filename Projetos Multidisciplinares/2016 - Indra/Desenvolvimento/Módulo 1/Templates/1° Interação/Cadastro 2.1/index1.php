...
<!--        <script type="text/javascript" src="js/jquery-1.2.6.pack.js"></script>
    ...
    <script language="JavaScript" type="text/javascript" src="js/validacaoMascara.js"></script>
    <script>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">  
                        <form  class="form_cadastro" method="post" action="cadastrar_usuario.php" novalidate id = "form_cadastro">
                            <div  class="row">
                                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Email:</label>
                                        <input type="email" class="form-control" pattern="^[_A-z0-9@./\-/]{1,}$" placeholder="Email"  minlength="1" maxlength="100" name="USU_EMAIL" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Rua:</label>
                                        <input type="text" id="endereco" class="form-control"   pattern="^[A-z/\ /]{1,}$" minlength="1" maxlength="100" placeholder="Rua" name="USU_RUA" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" pattern="^[A-z0-9]{1,}$" placeholder="Numero da Residencia"  minlength="1" maxlength="6" name="USU_NUMERO_RESIDENCIA" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label> Cidade:</label>
                                        <input type="text" id="cidade" class="form-control"  placeholder="Cidade" minlength="1" maxlength="70"  pattern="^[A-z/\ /]{1,}$" name="USU_CIDADE" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">                   
                                        ...
                                        <div>
                                            <select style="float: left;" class="form-control" required name="tipo_usuario" onchange="mostrar_formulario(this.value);">
                                    ...
                                    <div id="form_instituicao" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>CNPJ:</label>
                                                    <input type="text" class="form-control" placeholder="cnpj" name="INS_CNPJ"  maxlength="18" onKeyPress="mascara(this, '##.###.###/####-##')" required>
                                                </div>
                                    ...
                                    <div id="form_especialista" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>RG:</label>
                                                    <input type="text" class="form-control" placeholder="RG" maxlength="13" name="ESP_RG" onKeyPress="mascara(this, '##.###.###-##')" required>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>CPF:</label>
                                                    <input type="text" class="form-control" placeholder="cpf" maxlength="14" name="ESP_CPF" onKeyPress="mascara(this, '###.###.###-##')" required>
                                                </div>
...
<div id="modal-recuperar" class="elemento-escondido">

<form name="sentMessage" id="form-recuperar" novalidate>
<div class="row control-group">
...
<script src="js/validatorCadastro.js"></script>
