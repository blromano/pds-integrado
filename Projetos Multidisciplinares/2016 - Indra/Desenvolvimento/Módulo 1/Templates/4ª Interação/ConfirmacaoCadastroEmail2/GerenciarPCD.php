...
//    header('location:GerenciarPCD.php');
//} else {
                    ...
                    <table id="tabela-usuarios" class="table table-condensed">
                        <thead>
                            <tr bgcolor="#3a4857">
                                ...
                                <th style="width:25%">Status Func.</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    $id = $value->getId();
                                    ?>
                                    <td class = "interesse"><label><input type="checkbox"></label></td>
                                    <td class = "id"><?php echo $value->getId(); ?></td>
                                    <td class = "statusFuncionamento" ><?php echo $value->getStatusFuncionamento(); ?></td>
