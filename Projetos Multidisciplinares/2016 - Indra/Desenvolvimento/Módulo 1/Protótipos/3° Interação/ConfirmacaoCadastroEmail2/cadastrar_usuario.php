...
//cadastro usuario instituicao
    if ($idNivel == 4) {
        ...
        $usuarioInstituicao->setUserId($usuarioDAO->getId());
...
//cadastro usuario Especialista
    if ($idNivel == 3) {
        ...
        $usuarioEspecialista->setUserId($usuarioDAO->getId());
...
//caso o nomes de pastas ou a disposção das mesmas mudarem, deve-se modificar o link
    $txtMensagem = "<h3>Bem Vindo ao INDRA</h3><br><br>"
            ...
            . "http://localhost/ConfirmacaoCadastroEmail2/ConfirmarCadastro.php?cod=$cod<br><br>"
