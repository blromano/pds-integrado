                        ...
                        <form  class="form_cadastro" method="post" action="cadastrar_usuario.php" novalidate id = "form_cadastro">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Rua:</label>
                                        <input type="text" class="form-control" minlength="1" maxlength="100" placeholder="Rua" name="USU_RUA" required>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Complemento" name="USU_COMPLEMENTO" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label> Cidade:</label>
                                        <input type="text" class="form-control" placeholder="Cidade" minlength="1" maxlength="70" name="USU_CIDADE" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="rasão social">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="currículo">
                                                </div>
