...
!function(D, u) {
    ...
    function C(D, u, e, F, i, C, n) {
        var s, E, r, o, l, d, a, h, f, c, g, m, v = p(D), w = B("paddingLeft", v), _ = -999, S = B("borderBottomWidth", v) + B("borderTopWidth", v), b = B("borderLeftWidth", v) + B("borderRightWidth", v), T = B("paddingTop", v) + B("paddingBottom", v), N = B("paddingLeft", v) + B("paddingRight", v), L = B("fontSize", v) * (u.lineThreshold || .2), W = v.textAlign, O = [], H = [], j = [], k = u.wordDelimiter || " ", V = u.tag ? u.tag : u.span ? "span" : "div", M = u.type || u.split || "chars,words,lines", R = i && ~M.indexOf("lines") ? [] : null, P = ~M.indexOf("words"), q = ~M.indexOf("chars"), G = t(u), I = u.linesClass, J = ~(I || "").indexOf("++"), K = [], Q = "flex" === v.display, U = D.style.display;
        ...
        if (R || G)
            for (s = 0; s < r; s++)
                ((d = (o = l[s]).parentNode === D) || G || q && !P) && (m = o.offsetTop,
                R && d && Math.abs(m - _) > L && ("BR" !== o.nodeName || 0 === s) && (a = [],
                R.push(a),
                _ = m),
                G && (o._x = o.offsetLeft,
                o._y = m,
                o._w = o.offsetWidth,
                o._h = o.offsetHeight),
                R && ((o._isSplit && d || !q && d || P && d || !P && o.parentNode.parentNode === D && !o.parentNode._isSplit) && (a.push(o),
                o._x -= w,
                z(o, D, k) && (o._wordEnd = !0)),
                "BR" === o.nodeName && (o.nextSibling && "BR" === o.nextSibling.nodeName || 0 === s) && R.push([])));
        for (s = 0; s < r; s++)
            if (d = (o = l[s]).parentNode === D,
            "BR" !== o.nodeName)
                if (G && (f = o.style,
                P || d || (o._x += o.parentNode._x,
                ...
                !P && q)
                    if (o._isSplit)
                        for (o._next = E = o.nextSibling,
                        o.parentNode.appendChild(o); E && 3 === E.nodeType && " " === E.textContent; )
                            o._next = E.nextSibling,
                            o.parentNode.appendChild(E),
                            E = E.nextSibling;
                    else
                        o.parentNode._isSplit ? (o._parent = o.parentNode,
                        ...
                        l.splice(s--, 1),
                        r--) : d || (m = !o.nextSibling && z(o.parentNode, D, k),
                    ...
                    o.parentNode._isSplit && !o._isSplit && "" !== o.innerHTML ? H.push(o) : q && !o._isSplit && ("span" === V && (o.style.display = "inline"),
                    O.push(o));
            else
                R || G ? (o.parentNode && o.parentNode.removeChild(o),
                l.splice(s--, 1),
                r--) : P || D.appendChild(o);
        for (s = K.length; -1 < --s; )
            K[s].parentNode.removeChild(K[s]);
        if (R) {
            for (G && (c = X.createElement(V),
            D.appendChild(c),
            g = c.offsetWidth + "px",
            ...
            s = 0; s < R.length; s++) {
                ...
                r = a.length,
                E = 0; E < r; E++)
                    "BR" !== a[E].nodeName && (o = a[E],
                    c.appendChild(o),
                    h && o._wordEnd && c.appendChild(X.createTextNode(" ")),
                    G && (0 === E && (c.style.top = o._y + "px",
                    c.style.left = w + m + "px"),
                    o.style.top = "0px",
    ...
    function D(D, e, F, i) {
        var C, n, s, E, r, o, l, d, a = e.tag ? e.tag : e.span ? "span" : "div", p = ~(e.type || e.split || "chars,words,lines").indexOf("chars"), h = t(e), f = e.wordDelimiter || " ", B = " " !== f ? "" : h ? "&#173; " : " ", c = "</" + a + ">", A = 1, g = e.specialChars ? "function" == typeof e.specialChars ? e.specialChars : u : null, m = X.createElement("div"), y = D.parentNode;
        ...
        s = 0; s < r; s++)
            ...
            g && (d = g(C.substr(s), e.specialChars)))
                ...
                A = 0; C.charAt(s + 1) === f; )
                    n += B,
                    s++;
                s === r - 1 ? n += B : ")" !== C.charAt(s + 1) && (n += B + F(),
                A = 1)
            } else
                "{" === o && "{{LT}}" === C.substr(s, 6) ? (n += p ? i() + "{{LT}}</" + a + ">" : "{{LT}}",
                s += 5) : 55296 <= o.charCodeAt(0) && o.charCodeAt(0) <= 56319 || 65024 <= C.charCodeAt(s + 1) && C.charCodeAt(s + 1) <= 65039 ? (E = ((C.substr(s, 12).split(v) || [])[1] || "").length || 2,
    ...
    function E(u, e, F, i) {
        var C, n, r = s(u.childNodes), o = r.length, l = t(e);
        if (3 !== u.nodeType || 1 < o) {
            for (e.absolute = !1,
            C = 0; C < o; C++)
                (n = r[C])._next = n._isFirst = n._parent = n._wordEnd = null,
                3 === n.nodeType && !/\S+/.test(n.nodeValue) || (l && 3 !== n.nodeType && "inline" === p(n).display && (n.style.display = "inline-block",
    ...
    var X, F, i, n, _ = /(?:\r|\n|\t\t)/g, S = /(?:\s\s+)/g, r = "SplitText", o = m(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), l = function(D) {
        var u = "undefined" != typeof window
          , e = 0 === (u ? window.location.href : "").indexOf(m(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(m(108, 111, 99, 97, 108, 104, 111, 115, 116)) || -1 !== D.indexOf(m(49, 50, 55, 46, 48, 32, 48, 46, 49))
        ...
        for (setTimeout(function checkWarn() {
            u && ("loading" === document.readyState || "interactive" === document.readyState ? document.addEventListener("readystatechange", checkWarn) : (document.removeEventListener("readystatechange", checkWarn),
            u && window.console && !window._gsapWarned && "object" == typeof window.gsap && !1 !== window.gsap.config().trialWarn && (console.log(m(37, 99, 87, 97, 114, 110, 105, 110, 103), m(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)),
            console.log(m(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) + r + m(32, 105, 115, 32, 108, 111, 97, 100, 101, 100, 32, 116, 104, 97, 116, 32, 111, 110, 108, 121, 32, 119, 111, 114, 107, 115, 32, 108, 111, 99, 97, 108, 108, 121, 32, 97, 110, 100, 32, 111, 110, 32, 100, 111, 109, 97, 105, 110, 115, 32, 108, 105, 107, 101, 32, 99, 111, 100, 101, 112, 101, 110, 46, 105, 111, 32, 97, 110, 100, 32, 99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111, 46, 32, 42, 42, 42, 32, 68, 79, 32, 78, 79, 84, 32, 68, 69, 80, 76, 79, 89, 32, 84, 72, 73, 83, 32, 70, 73, 76, 69, 32, 42, 42, 42, 32, 76, 111, 97, 100, 105, 110, 103, 32, 105, 116, 32, 111, 110, 32, 97, 110, 32, 117, 110, 97, 117, 116, 104, 111, 114, 105, 122, 101, 100, 32, 115, 105, 116, 101, 32, 118, 105, 111, 108, 97, 116, 101, 115, 32, 116, 104, 101, 32, 108, 105, 99, 101, 110, 115, 101, 32, 97, 110, 100, 32, 119, 105, 108, 108, 32, 99, 97, 117, 115, 101, 32, 97, 32, 114, 101, 100, 105, 114, 101, 99, 116, 46, 32, 80, 108, 101, 97, 115, 101, 32, 106, 111, 105, 110, 32, 67, 108, 117, 98, 32, 71, 114, 101, 101, 110, 83, 111, 99, 107, 32, 116, 111, 32, 103, 101, 116, 32, 102, 117, 108, 108, 32, 97, 99, 99, 101, 115, 115, 32, 116, 111, 32, 116, 104, 101, 32, 98, 111, 110, 117, 115, 32, 112, 108, 117, 103, 105, 110, 115, 32, 116, 104, 97, 116, 32, 98, 111, 111, 115, 116, 32, 121, 111, 117, 114, 32, 97, 110, 105, 109, 97, 116, 105, 111, 110, 32, 115, 117, 112, 101, 114, 112, 111, 119, 101, 114, 115, 46, 32, 68, 105, 115, 97, 98, 108, 101, 32, 116, 104, 105, 115, 32, 119, 97, 114, 110, 105, 110, 103, 32, 119, 105, 116, 104, 32, 103, 115, 97, 112, 46, 99, 111, 110, 102, 105, 103, 40, 123, 116, 114, 105, 97, 108, 87, 97, 114, 110, 58, 32, 102, 97, 108, 115, 101, 125, 41, 59)),
            console.log(m(37, 99, 71, 101, 116, 32, 117, 110, 114, 101, 115, 116, 114, 105, 99, 116, 101, 100, 32, 102, 105, 108, 101, 115, 32, 97, 116, 32, 104, 116, 116, 112, 115, 58, 47, 47, 103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109, 47, 99, 108, 117, 98), m(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)),
            window._gsapWarned = 1)))
        }, 50); -1 < --F; )
            if (-1 !== D.indexOf(t[F]))
                return !0;
        return e || !setTimeout(function() {
            u && (window.location.href = m(104, 116, 116, 112, 115, 58, 47, 47) + o + m(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=" + r + "&source=trial")
        }, 3e3)
    }("undefined" != typeof window ? window.location.host : ""), d = Array.isArray, a = [].slice, h = ((n = SplitText.prototype).split = function split(D) {
