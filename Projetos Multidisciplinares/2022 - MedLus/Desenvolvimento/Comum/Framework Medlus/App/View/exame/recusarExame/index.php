...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-danger">Recusar o Exame : <?php echo $dado->__get("EXA_NOME")?></h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                <form action="./recusado?id=<?php echo $dado->__get("EXA_ID")?>" method="POST" class="d-flex justify-content-center row">
                    ...
                    <div class="input-group  mb-3 row">
                        <label class="form-label col-2 mt-2" for="justificativa">Justificativa:</label>
                        <textarea class="form-control col-3" id='justificativa' name="justificativa"></textarea>
                    </div>
