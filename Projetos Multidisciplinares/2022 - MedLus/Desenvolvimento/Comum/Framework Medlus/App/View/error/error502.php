...
<div class="container_error">
	<p class="textA"> AÇÃO INDISPONÍVEL</p>
	<p class="textB">502</p>
	<a class="textC" onclick = " window.history.back();">Voltar</a>
	<svg class="page-not-found" viewBox="0 0 1280 1024">
		...
		<g class="box">
			...
			<polygon points="387.8 285.6 763 258.9 800.4 336.1 420 350 395 300" style="fill: #e74a3b" />
			<polygon points="709.7 622 933.7 622.3 960.9 662.9 931.9 700.1 708.7 699.4 709.7 622" style="fill: #e74a3b" />
		</g>
		...
		<g class="hide words">
			...
			<text transform="translate(479.2 549.5)" style="font-size: 180px;fill: #032c3f;font-family: Futura-CondensedExtraBold, Futura;font-weight: 700">5<tspan x="108.3" y="0" style="letter-spacing: -0.0009765625em">0</tspan>
				<tspan x="216.4" y="0">2</tspan>
			</text>
		</g>
	</svg>
</div>