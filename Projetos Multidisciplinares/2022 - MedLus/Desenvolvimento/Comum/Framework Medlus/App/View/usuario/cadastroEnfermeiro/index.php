...
if (isset($_GET['status']) && $_GET['status'] == '203') {
    echo "Cadastro de Enfermeiro, todos os campos devem ser preenchidos!";
}
?>

<!-- DataTales Example -->
<div class="col-12 d-flex flex-column align-items-center w-100" id="cadastroEnfermeiro">
    <h1 class="h3 mb-2 text-gray-800 my-4">Cadastro Enfermeiro(a)</h1>
    <form class="user" class="col-12 col-md-6 col-lg-4" action="" method="post">
        ...
        <div class="form-group row">
            <div class="col-sm-6 mb-3 mb-sm-0">
                <input type="password" class="form-control rounded-pill" id="USU_SENHA" name="USU_SENHA" placeholder="Senha">
            </div>
            <div class="col-sm-6">
                <input type="password" class="form-control rounded-pill" id="USU_SENHA" name="USU_SENHA" placeholder="Confirme a senha">
            </div>
        </div>
