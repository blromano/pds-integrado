...
if (isset($_GET['status']) && $_GET['status']=='203'){
    echo "Cadastro Médico, todos os campos devem ser preenchidos!";
}
?>

<!-- DataTales Example -->
<div class="col-12 d-flex flex-column align-items-center w-100" id="cadastroMedico">
    <h1 class="h3 mb-2 text-gray-800 my-4">Cadastro Médico</h1>
