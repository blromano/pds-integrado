<?php
    ...
    use App\Model\PrescricaoMedicaModel;
    use App\DAO\PrescricaoMedicaDAO;


    class PrescricaoMedicaController extends Action {
        public function prescricaomedica(){
            ...
            // $consultasPresencial = $consultaPresencialDAO->buscarPorId($idPrescricao);
            


            // $this->getView()->prescricaoMedica = $prescricaoMedica;                
