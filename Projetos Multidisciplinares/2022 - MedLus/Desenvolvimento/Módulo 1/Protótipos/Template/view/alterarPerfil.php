        ...
        <section class="bg-white mt-5 mb-5 listagem d-flex align-items-center flex-column px-5 col-md-6 col-sm-12 col-lg-3">
            ...
            <div class="py-5 data">
                ...
                <div class="row mt-1">
                    ...
                    <div>
                    <a type="button" class="aa" href="editarDadosPerfil.php" > Editar </a>
                    </div>
                    <div>
                        <a type="button" class="btn btn-sm btn-danger botaover" href="indexExemplo.php" > Cancelar </a>
                    </div>
