                        ...
                        <div class="col-md-12">
                            <table class="table-striped">
                                <thead>
                                    <?php
                                        if(!$this->getView()->denuncias == null) {
                                            echo "<tr class='table'>
                                                <th class='font-weight-bold text-green' scope='col'>Título da Denúncia</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td> <a class="title-link" href=""><?= $denuncia->__get('DEN_TITULO'); ?></a> </td>
                                            ...
                                            <td class="d-flex flex-row">
                                                <a class="btn btn-warning btn-size mr-2" style="color: white; text-decoration: none" href="/dashboard/visualizarDenuncia?id=<?= $denuncia->__get('DEN_ID'); ?>">Visualizar</a>
                                                <a class="btn btn-success btn-color btn-size mr-2" style="color: white; text-decoration: none" href="/dashboard/editarDenuncia?id=<?= $denuncia->__get('DEN_ID'); ?>">Editar</a>
