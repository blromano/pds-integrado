<div class="card">
    <div class="card-header">
        <div class="row justify-content-between alinhar">
            ...
            <div class="">
                <a class="a_j" href="/dashboard/registrarDescarte"><button type="button"
    ...
    <div class="card-body">
        ...
        <table class="table_j table-hover table-sm table-striped">
            ...
            <tbody>
                <?php foreach ($this->getView()->descarte_residuo as $dado) { ?>
                    <tr class="residuo-row">
                        <th scope="row" id="<?php echo $dado->__get("DSR_ID"); ?>">
                            <?php echo $dado->__get("DSR_ID"); ?>
                        </th>
                        <?php
                        // Percorra o array $this->getView()->residuo_solido em busca do elemento correspondente com base no ID
                        ...
                        ?>
                        <td>
                            <?php echo $matchingResiduo->__get("RES_NOME_RESIDUO"); ?>
                        </td>
                        <td>
                            <?php echo $dado->__get("DSR_QUANTIDADE"); ?>
                        </td>
                        <td>
                            <?php echo $dado->__get("DSR_DATA_HORA_DESCARTE"); ?>
                        </td>
                        <?php
                        ...
                        ?>
                        <td>
                            <?php echo $matchingPonto->__get("PCO_NOME"); ?>
                        </td>
                        <td>
                            <a class="a_j" href="/dashboard/editarDescarte?id=<?php echo $dado->__get("DSR_ID"); ?>">
                                <button type="button" class="btn btn-info btn-sm">
                                    <i class="bi bi-pencil-square"></i> Editar
                                </button>
                            </a>
                            <a class="a_j" data-id="<?php echo $dado->__get('DSR_ID'); ?>"
                                onclick="abrirPopup(this, <?php echo $dado->__get('DSR_ID'); ?>, '<?php echo $matchingResiduo->__get('RES_NOME_RESIDUO'); ?>', '<?php echo $dado->__get('DSR_QUANTIDADE'); ?>', '<?php echo $dado->__get('DSR_DATA_HORA_DESCARTE'); ?>', '<?php echo $matchingPonto->__get('PCO_NOME'); ?>')">
