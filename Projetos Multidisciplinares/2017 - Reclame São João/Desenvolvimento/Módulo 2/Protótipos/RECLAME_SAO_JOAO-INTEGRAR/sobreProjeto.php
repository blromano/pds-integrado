      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">   
			<li class="scroll active"><a href="#SobreProjeto">Sobre Projeto</a></li>
    ...
    <div id="contact-us" class="parallax">
      <div class="container">
        ...
        <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="row">
            <div class="col-sm-6 " style="width: 100%; margin-left:25%; margin-top: -5%; text-align:center; float:center;position:relative;">
               <div class="col-sm-6" ">
                    <div class="##">          
					  <p>Por falta de um portal de comunicação para a população de São João fazer suas reclamações em relação aos estabelecimentos da
					  cidade, foi desenvolvido um projeto que atenda a população e os estabelecimentos fixados em São João da Boa Vista, permitindo aos mesmos
					  o acesso ao portal Reclame São João de modo que a comunidade Sanjoanense possa logar, editar e interagir entre si. </p><br/>
					  Ao alcançar esse sucesso, estaremos proporcionando para a cidade um novo sistema que pode impulsionar o comércio 
					  justo e maior comprometimento por parte dos estabelecimentos presentes na cidade.					  
                    </div>
                  </div>			  
            </div>
          </div>
