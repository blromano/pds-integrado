        ...
        <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="row">
            <div class="col-md-6 col-md-offset-3">
              <form id="formEmail" name="formEmail" method="post" action="php/mod01/envioEmailRecuperarSenha.php" style="border: 1px solid white; padding: 15px; 30px 0px;">                				
			
                <div class="form-group">
                  <input type="text" name="USU_EMAIL" class="form-control" placeholder="Email" required="required">
                </div>
