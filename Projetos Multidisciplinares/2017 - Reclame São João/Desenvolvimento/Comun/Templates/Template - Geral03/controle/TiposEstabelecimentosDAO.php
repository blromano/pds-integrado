<?php
	...
	{		
		...
		try {
			$this->resultado->execute();
			echo "<script>alert('Estabelecimento deletado com sucesso!')</script><script>window.location='../../../php/mod05/index.php?pagina=10';</script>";
		} catch(PDOException $e) {
			echo "<script>alert('Erro ao deletar. Tipo de estabelecimento já está em uso!')</script><script>window.location='../../../php/mod05/index.php?pagina=10';</script>";
		}
