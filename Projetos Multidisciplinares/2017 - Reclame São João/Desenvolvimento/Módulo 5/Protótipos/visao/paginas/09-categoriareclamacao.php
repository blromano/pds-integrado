	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="paginas/gerenciamento/TiposReclamacao/editarTiposReclamacao.php" method="post" data-toggle="validator" role="form">
...
<div id="remover" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="paginas/gerenciamento/TiposReclamacao/removerTiposReclamacao.php" method="post">
...
<div id="add" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="paginas/gerenciamento/TiposReclamacao/inserirTiposReclamacao.php" method="post" data-toggle="validator" role="form">
					<div class="form-group">
