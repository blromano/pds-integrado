<?php
	...
	{		
		...
		try {
			$this->resultado->execute();
			echo "<script>alert('Tipo de reclamação deletado com sucesso!')</script><script>window.location='../../../index.php?pagina=9';</script>";
		} catch(PDOException $e) {
			echo "<script>alert('Erro ao deletar. Tipo de reclamação já está em uso!')</script><script>window.location='../../../index.php?pagina=9';</script>";
		}
