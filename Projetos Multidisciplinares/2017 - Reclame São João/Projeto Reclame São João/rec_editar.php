<?php
	...
	$REC_TITULO_RECLAMACAO = $ReclamacaoDAO->retornandoTitulo();
	$REC_DESCRICAO = $ReclamacaoDAO->retornandoDescricao();
     ...
     <div class="main-nav">
      <div class="container">
		...
		<div class="collapse navbar-collapse">
			...
			<li class="scroll active" id="menu_botao"><a href="#main-wrapper" id="cabecalho_a">Editar Reclamação</a></li>
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<div id="header-wrapper">
					<div id="header" class="container">
						<!-- Logo -->
							...
							<p>Bem Vindo a página de Edição da Reclamação. Aqui voce pode editar sua reclamação.</p>
				...
				<td><center><span class="form_titulo">Altere o formulário se <br/>achar <strong>necessário!</strong></span></center></td>
				</tr>
				</table></center>
				...
				<tr>
				<td><center><span class="form_titulo">Altere o formulário se achar <strong>necessário!</strong></span></center></td>
				</tr>
				</table></center>
				...
				<input type="text" name="REC_TITULO_RECLAMACAO" id="form_titulo2" required="required" maxlength="50" value="<?php echo $REC_TITULO_RECLAMACAO ?>"/>
