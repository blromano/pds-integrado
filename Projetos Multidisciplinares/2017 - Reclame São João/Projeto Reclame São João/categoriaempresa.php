...
<div class="panel-heading"><span class="fa fa-bookmark" aria-hidden="true"></span> Categorias > Tipos de Estabelecimentos</div>
	...
	<div class = "modal-dialog" >
		<div class = "modal-content" >
			...
			<div class = "modal-body" >
                            <form action = "php/mod05/gerenciamento/TiposEstabelecimento/update_TiposEstabelecimento.php" method = "post" data-toggle="validator" role="form">
					<ul class = "list-group" >
...
<div id = "remover" class = "modal fade" role = "dialog" >
	<div class = "modal-dialog" >
		<div class = "modal-content" >
			...
			<div class = "modal-body" >
				<form action = "php/mod05/gerenciamento/TiposEstabelecimento/deleta_TiposEstabelecimento.php" method = "post" >
					<ul class = "list-group" >
...
<div id = "add" class = "modal fade" role = "dialog">
	<div class = "modal-dialog" >
		<div class = "modal-content" >
			...
			<div class = "modal-body" >
				<form action = "php/mod05/gerenciamento/TiposEstabelecimento/add_TiposEstabelecimento.php" method = "post" data-toggle="validator" role="form" >
					<div class = "form-group" >
