<?php
	...
	$registro = $EstabelecimentosDAO->listarADM();
...
<div class="panel-heading"><span class="fa fa-users" aria-hidden="true"></span> Usuários > Estabelecimentos</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="php/mod05/gerenciamento/Estabelecimentos/editarEstabelecimentos.php" method="post" data-toggle="validator" role="form">
...
<div id="remover" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="php/mod05/gerenciamento/Estabelecimentos/removerEstabelecimentos.php" method="post">
