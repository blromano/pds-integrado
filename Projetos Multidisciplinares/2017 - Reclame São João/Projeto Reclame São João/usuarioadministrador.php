...
<div class="panel-heading">
	<span class="fa fa-users" aria-hidden="true"></span> Usuários > Administradores
	<span class="pull-right">
		<button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#add"><i class="fa fa-plus" aria-hidden="true"></i> Adicionar</button>
	</span></div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="php/mod05/gerenciamento/Administradores/editarAdministradores.php" method="post" data-toggle="validator" role="form">
...
<div id="remover" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="php/mod05/gerenciamento/Administradores/removerAdministradores.php" method="post">
...
<div id="add" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="php/mod05/gerenciamento/Administradores/inserirAdministradores.php" method="post" data-toggle="validator" role="form">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="nome"><strong>Nome:</strong></label>
