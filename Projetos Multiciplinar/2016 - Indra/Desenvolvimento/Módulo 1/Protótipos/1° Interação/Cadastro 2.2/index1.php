...
<!--        <script type="text/javascript" src="js/jquery-1.2.6.pack.js"></script>
    ...
    <script language="JavaScript" type="text/javascript" src="validacaoMascara.js"></script>
    <script>
                        ...
                        <form  class="form_cadastro" method="post" action="cadastrar_usuario.php" novalidate id = "form_cadastro">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>CEP:</label>
                                        <input type="text" class="form-control" placeholder="CEP" pattern="^[0-9/\.//\-/]{1,}$" maxlength="9" onKeyPress="mascara(this, '99999-999')"  name="USU_CEP" id="cep" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Rua:</label>
                                        <input type="text" class="form-control"   pattern="^[A-z/\ /]{1,}$" minlength="1" maxlength="100" placeholder="Rua" name="USU_RUA" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label> Cidade:</label>
                                        <input type="text" class="form-control"  placeholder="Cidade" minlength="1" maxlength="70"  pattern="^[A-z/\ //\á//\à//\ã//\é//\ó//\õ//\ /]{1,}$" name="USU_CIDADE" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">                   
                                        <label>Estado:</label>
                                        <div>
                                            <select style="float: left;" class="form-control" required name="USU_ESTADO">
