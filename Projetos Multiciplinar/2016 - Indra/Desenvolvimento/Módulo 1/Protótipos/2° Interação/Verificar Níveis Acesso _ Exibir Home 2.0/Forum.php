                ...
                <div class="row">
				   ...
				   <div class="form-group">
						...
						<select class="form-control select">
							...
							<option value="s1">Dúvida</option>
							<option value="s2">Critíca</option>
							<option value="s3">Sugestões</option>
						</select>
						<br></br>
						<label for="comment">Digite sua mensagem:</label>
							<textarea id="comment" class="form-control" rows="5" style="width: 100%"></textarea>
					</div>
