...
if(!isset($_SESSION['user'])){
    ...
    if(($_SESSION['user']->getNivelAcesso() == 1) && ($_SESSION['user']->getNivelAcesso() == 4) ){
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="float:right">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="">
                            <a href="MeuPerfil1.php"> Meu Perfil</a>  
                        </li>
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="col-md-4 ferramentas">
                            <div class="thumbnail" >
                                ...
                                <div class="caption link-ferramenta"  >
                                    <h3>PCDs</h3>
                                    <p>Descri&ccedil;&atilde;o</p>
                                    <p><a href="GerenciarPCD.php" role="button">Saiba mais...</a></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 ferramentas">
                            <div class="thumbnail">
                                ...
                                <div class="caption link-ferramenta" >
                                    <h3>Alertas</h3>
                                    <p>Descri&ccedil;&atilde;o</p>
                                    <p><a href="Alertas.php" role="button">Saiba mais...</a></p>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="col-md-4 ferramentas">
                        <div class="thumbnail">
                            ...
                            <div class="caption link-ferramenta" >
                                <h3>Fale Conosco</h3>
                                <p>Nos envie sua opniçao e dúvidas</p>
                                <p><a href="FaleConosco.php" role="button">Saiba mais...</a></p>
                            </div>
                        </div>
                    </div>
                        <div class="col-md-4 ferramentas" >
