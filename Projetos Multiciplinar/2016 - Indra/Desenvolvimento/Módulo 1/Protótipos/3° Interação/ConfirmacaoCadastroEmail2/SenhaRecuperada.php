            ...
            <div class="row">
                <div class="col-lg-12">                
                    <div class="intro-text">
                        <span class="skills">Recuperação de Senha</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container elemento-expandido">
            <div class="row">
                <div class="col-lg-12 text-center">
                 ...
                 <p> Olá, sua senha foi modificada. </p>
                 <p>Para verificar sua nova senha vá até seu email <?php  echo $endereco; ?>, e faça seu login.</p>
                  <?php 
