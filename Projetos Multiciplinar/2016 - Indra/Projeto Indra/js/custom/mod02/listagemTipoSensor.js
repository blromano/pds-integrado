$(document).ready(function() {
 ...
 var tabela = $('#lista-tiposensor').DataTable({
	...
	$('#btnCriar').on('click', function(){
		...
		$.ajax({
			url: '../../class/mod02/cadastrarTipoSensor.php',
			data: info,
			dataType: "JSON",
			method: 'POST',
...
var rafaelquercagar = $(this).parent().siblings('.tipomed').html();
var info = {tipomed:rafaelquercagar};
$.ajax({
			url: '../../class/mod02/idTipoMedicaoPorDescricao.php',
			data: info,
			method: 'POST',
			success: function(data){
				$('#editar-tiposensor-modal .timed').val(data);
			}
	});
$('#editar-tiposensor-modal .timed').val($(this).parent().siblings('.tipomed').html());
...
$('#btnEditar').on('click', function(){
	...
	$.ajax({
		url: '../../class/mod02/editarTipoSensor.php',
		data: info,
		dataType: "JSON",
		method: 'POST',
		success: function(data){
...
$('#btnExcluir').on('click', function(){
		...
		var info = {idtiposensor:valores};
		 $.ajax({
		  url: '../../class/mod02/excluirTipoSensor.php',
		  data: info,
			dataType: "JSON",
			method: 'POST',
			success: function(data){
