...
<html>
    <head>
        ...
        <link href="<?php echo $this->view->include ?>resources/CSS/cssmd3.css" rel="stylesheet" type="text/css"/>
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-light border">
                <div class="container-fluid">
                    <a href="/" class="navbar-brand"> 
                        <img src="<?php echo $this->view->include ?>resources/img/logo.png" alt="logo"/>
                    </a>
