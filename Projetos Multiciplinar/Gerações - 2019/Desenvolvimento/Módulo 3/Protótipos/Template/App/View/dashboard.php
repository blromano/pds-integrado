...
<head>
  ...
  <link href="<?php echo $this->view->include ?>resources/CSS/cssmd3.css" rel="stylesheet">
</head>
    ...
    <ul class="sidebar navbar-nav bg-dark">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="/md3/PatologiasPrescricoes">Patologias/Prescrições</a>
    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="row d-flex justify-content-center align-items-center">
            ...
            <p class="pt-3 pr-2">Desculpe, informação indiponível no momento</p>
