  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav bg-dark">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <a class="dropdown-item" href="/md6/alimento">Alimento</a>
          <a class="dropdown-item" href="/md6/tipodealimento">Tipo de alimento</a>
          <a class="dropdown-item" href="/md6/planosalimentares">Planos Alimentares</a>
          <a class="dropdown-item" href="/md6/consultaFeedback">Dados de consulta</a>
          <a class="dropdown-item" href="/md6/consulta">Consulta</a>
          <a class="dropdown-item" href="/md6/amostra">Amostra</a>
          <a class="dropdown-item" href="/md6/statusdeAlimentacao">Status de alimentação</a>
