...
<center><b>Registrar Amostras </b> </center>
</br>
 <center><img src="alimentos-desenho-png-4.png"width="20%" height="20%" /></center>
<form action="pagina de ação" method="post" name="dados" onSubmit="return enviardados();" >
  <table width="200" border="0" align="center" >
    ...
    <tr>
      <p><td width="118"><font size="4" face="Verdana, Arial, Helvetica, sans-serif">Data de Entrada:</font></td></p>
      <td width="260">
        <input type="datetime-local" name="bdaytime">
      </td>
    </tr>
	 <tr>
      <p><td width="118"><font size="4" face="Verdana, Arial, Helvetica, sans-serif">Data de saida:</font></td></p>
      <td width="260">
        <input type="datetime-local" name="bdaytime">
      </td>
    </tr>
	<tr>
      <p><td width="118"><font size="4" face="Verdana, Arial, Helvetica, sans-serif">Data da refeição:</font></td></p>
      <td width="260">
        <input type="datetime-local" name="bdaytime">
      </td>
    </tr>
	<tr>
          ...
          <p><td width="118"><font size="4" face="Verdana, Arial, Helvetica, sans-serif">Foto:formato PNG </font></td></p>
         <td width="260">
          <input type="file" />
      </td>
    </tr>
	
	<P> Selecione a Refeição do dia </P>
	<select name="estados-brasil">
	<option value="AC">Café da manhã</option>
	<option value="AC">Brunch</option>
	<option value="AL">Almoço</option>
	<option value="AC">Lanche</option>
	<option value="AP">Jantar</option>
	<option value="AC">Ceia</option>
	</select>
