<div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Editar Vacinação</li>
        </ol>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-3">
                      ...
                      <input type="text" class="form-control" name="dose" id="dose" value="0,25">
                    </div>
                    <div class="col-3 mr-auto">
                      <label for="Login">Nome da Vacina</label>
                      <input type="text" class="form-control" name="tipo" id="tipo" value="Gripe">
                    </div>
                  </div>
                </div>
                <div class="form-group">
