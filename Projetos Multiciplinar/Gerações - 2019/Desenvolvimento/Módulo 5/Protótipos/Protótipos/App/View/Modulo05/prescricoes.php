<div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Gerenciamento de Prescrições</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-2">
                  <a href="/md5/cadastrarPrescricao" style="width:100%" class="btn btn-primary btn-sm">Inserir Prescrição</a>
                </div>
              </div>
            </div> 
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th>Data/Hora da Prescrição</th>
                    <th>Medicamento</th>
                    <th>Posologia</th>
                    <th>Validade da Prescrição</th>
                    <th>Observações</th>
                    <th>Ações</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td>Dipirona</td>
                    <td>4 comprimidos/dia (6 em 6 horas)</td>
                    <td>6 meses</td>
                    <td>-</td>
                    <td><a href="/md5/editarPrescricao" class="btn btn-primary btn-sm">Editar</a>
                      <a href="/md5/visualizarPrescricao" class="btn btn-primary btn-sm">Visualizar</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
