<div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Gerenciamento de Incidentes</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-2">
                  <a href="/md5/cadastrarIncidente" style="width:100%" class="btn btn-primary btn-sm">Inserir Incidente</a>
                </div>
              </div>
            </div> 
          <div class="card-body">
              ...
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Queda</td>
                    <td>Ferimentos leves. Não houve fratura.</td>
                    <td><a href="/md5/editarIncidente" class="btn btn-primary btn-sm">Editar</a></td></td>
                  </tr>
                </tbody>
              </table>
            </div>
