            ...
            <div class="row">
                ...
                <nav id="main-nav-wrap">
                    <ul class="main-navigation">
                        <li class="current"><a class="smoothscroll"  href="#intro" title="">Adicionar Patologias/Medicações Continuas</a></li>
            ...
            <div class="container" role="main" style="height: 100%;width: 100%; padding:5%; float:left; min-height: 100%" >
                ...
                <div class="container theme-showcase col-md-12" role="main">
                    <div class="page-header">
                        <h1>Adicionar Patologias e Medicações Contínuas</h1>
                        ...
                        <form class="col-md-4">
                            <div class="row form-group">
                                ...
                                <select class="form-control" name="patologias">
                                    <option value="null">Selecione uma  das patologias:</option>
                            ...
                            <div class="row form-group">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="outras_patologias" placeholder="Caso não encontre digite-a  aqui:"/>
                                </div>
                            ...
                            <div class="row form-group">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="outras_patologias" placeholder="Caso tome alguma medicação escreva aqui"/>
                                </div>

                            </div>
                            
                            
                             <button type="button" class="btn-xs btn-success">Adicionar Patologias/Medicações</button>
                              <button type="button" class="btn-xs btn-danger">Cancelar</button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Tem certeza que deseja que deseja excluir esse Administrador?</h4>
                        </div>
