            ...
            <div class="container" role="main" style="height: 100%;width: 100%; padding:5%; float:left; min-height: 100%" >
                ...
                <div class="container theme-showcase col-md-12" role="main">
                    <div class="page-header">
                        <h1>Lista de Administradores Ativos</h1>
                        <div style="text-align:right">
                            <a href="Adicionar_Administradores.php"><button type="button" class="btn btn-xs btn-success">Cadastrar Admnistradores</button> </a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
