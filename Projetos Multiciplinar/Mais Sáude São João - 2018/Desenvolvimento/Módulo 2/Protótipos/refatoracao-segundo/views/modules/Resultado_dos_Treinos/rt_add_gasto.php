        ...
        <section onclick="closeNav()">
            <div class="container" role="main" style="height: 100%;width: 100%; padding:5%">
                ...
                <div class="page-header">
                    <h1 style="color:#104999">Adicionar um gasto calórico
                    </h1>
                </div>
                <div class="container">
                    <form class="form">
                        ...
                        <div class="form-group">
                            <label for="tempo">Gastos calóricos:</label>
                            <input type="number" class="form-control" id="tempo" placeholder="Insira o tempo do exercício em minutos..." name="tempo">
                        </div>

                        <button>Adicionar gasto calórico</button><a href='?mod=rtreinos&sub=historico_gasto'> <button type='button' name="voltar"> Cancelar </button> </a>
                    </form>
                </div> 
            </div>
        </section>  
