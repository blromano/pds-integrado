<?php
include (CONTROLLERS_PATH . 'modules/Usuarios/pagina_essencial_sair_login.php');
?>
...
?>
        ...
        <section onclick="closeNav()">
            <div class="row">
                <div class="border col-md-8 offset-md-2 align-self-center mt-5">
                    <h1 class="text-center mt-3"> Seja bem vindo  <?php echo $_SESSION['nome_usuario'] ?>  </h1>
                </div>
