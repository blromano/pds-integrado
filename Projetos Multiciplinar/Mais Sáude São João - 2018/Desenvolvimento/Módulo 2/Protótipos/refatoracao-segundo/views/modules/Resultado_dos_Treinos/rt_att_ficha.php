        ...
        <section onclick="closeNav()">
            <div class="container" role="main" style="height: 100%;width: 100%; padding:5%">
                ...
                <div class="page-header">
                    <h1 style="color:#104999">Atualizar desempenho em ficha de treinamento
                    </h1>
                </div>
                <div class="container">
                    <form class="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="tempo" placeholder="Insira o tempo do exercício em minutos..." name="tempo">
                        </div>
                        <div class="form-group">
                            <label for="peso">Peso:</label>
                            <input type="number" class="form-control" id="peso" placeholder="Insira seu peso atual em KG..." name="peso">
                        </div>
                        <button>Atualizar desempenho</button>
                    </form>
                </div>
            </div>
        </section>  
