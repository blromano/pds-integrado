...
<body>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                          ...
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editar_medidas" data-dismiss="modal">Atualizar Medidas Corporais</button><br><br><br>
      ...
      <!-- Editar Medidas Corporais-->
          <div class="modal fade" id="editar_medidas" tabindex="-1" >
            ...
            <button type="button" class="btn btn-primary">Confirmar Medidas</button>
			<br>
			<br>
			...
			<button type="button" class="btn btn-primary">Confirmar Dobras Cutâneas</button>
			<br>
			<br>
            <div class="table-responsive">
                <table class="table table-condensed  table-striped">
