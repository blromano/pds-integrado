                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                          ...
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editar_medidas" data-dismiss="modal">Visualizar Medidas Corporais</button><br><br><br>
                          <h7>Registro de Dobras: </h7><br>
                          <h7>Medida1:  <h8>xx/xx/xxxx</h8></h7> <br> 
                          <h7>Medida2:  <h8>xx/xx/xxxx</h8></h7><br>
                          <h7>Medida3:  <h8>xx/xx/xxxx</h8></h7><br>
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editar_dobras" data-dismiss="modal">Visualizar Dobras Cutâneas</button>
          ...
          <div class="modal fade" id="editar_medidas" tabindex="-1" >
            ...
            <div class="table-responsive">
                <table class="table table-condensed  table-striped">
                    ...
                    <tbody>
                    <th scope="row">1</th>
                    <td><input type="text" value="xxCm" class="form-control" readonly></td>
                    <td><input type="text" value="xxcM" class="form-control" readonly></td>
                    <td><input type="text" value="xxcM" class="form-control" readonly></td>
                    <td><input type="text" value="xxcM" class="form-control" readonly></td>
                    <td><input type="text" value="xxcM" class="form-control" readonly></td>
                    ...
                    <td><input type="text" value="xxcM" class="form-control" readonly></td>
                    <td><input type="text" value="xxcM" class="form-control" readonly></td>
                    <td><input type="text" value="saudável" class="form-control" readonly></td>  
                    ...
                    <tr>
                     <th scope="row">3</th>
                    <td><input type="text" value="xxCm"  readonly></td>
                    <td><input type="text" value="xxcM"  readonly></td>
                    <td><input type="text" value="xxcM"  readonly></td>
                    <td><input type="text" value="xxcM"  readonly></td>
                    <td><input type="text" value="xxcM"  readonly></td>
                    ...
                    <td><input type="text" value="xxcM"  readonly></td>
                    <td><input type="text" value="xxcM"  readonly></td>
                    <td><input type="text" value="saudável" readonly></td>
					<tr>
                    </tbody>
                </table>
            </div>            
                  ...
                  <div class="modal-footer">
                  	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#mostrar_dados_usuario" data-dismiss="modal">Voltar</button>
                  </div>
                </div>
              </div>
          </div>
            ...
            <div class="table-responsive">
                <table class="table table-condensed  table-striped">
                    ...
                    <td><input type="text" value="xxcM" class="form-control" readonly></td>
                    <td><input type="text" value="xxcM" class="form-control" readonly></td>
                    <td><input type="text" value="média" class="form-control" readonly></td>          
                    ...
                    <td><input type="text" value="xxcM" readonly></td>
                    <td><input type="text" value="xxcM" readonly></td>
                    <td><input type="text" value="média" readonly>  
                    </tr>
                    </tbody>
                </table>
            </div>            
