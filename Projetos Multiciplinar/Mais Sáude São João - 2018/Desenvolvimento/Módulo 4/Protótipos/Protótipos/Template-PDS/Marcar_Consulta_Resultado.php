  ...
  ================================================== -->
   ...
   ================================================== -->
    ...
    <body style="background-color:white">
        ...
        <!--Corpo do texto ---> 
<div class="container" role="main" style="height: 100%;width:100%; padding:5%; float:center; min-height: 100%" >
            <br/>
            <br/>
            ...
            <div class="tabcontent offset-md-3" style="width: 50%;">
                        ...
                        <table class="table table-condensed  table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="radio" name="disponivel" value="checked"       style="margin-left:auto; margin-right:auto;width:20px; height:20px;"></td>
                                </tr>
                                <tr>
                ...
                <div class="offset-md-4" style="margin-top: 50px; padding-bottom: 300px;">
