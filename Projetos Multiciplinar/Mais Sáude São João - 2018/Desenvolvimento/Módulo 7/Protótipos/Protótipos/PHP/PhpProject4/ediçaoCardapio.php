...
<html lang="pt-br">
    ...
    <body>
     ...
     <div name="busca_usuario" >
      ...
      <label style="padding:0.4%"> Período indicado: Almoço </label>
      ...
      <div name="alimentos" >
                    <label style="padding:0.4%"> Alimento indicado 1: </label> 
                    <input  type="text" class="form-control" id="alimentos" placeholder="Ex: Banana, uva..." required> <br/>
  
                </div>
     
      <div name="porção" >
                    <label style="padding:0.4%"> Porção ideal 1: </label> 
      ...
      <div name="variação" >
                    <label style="padding:0.4%">Variações do alimento 1: </label> 
                    <input  type="text" class="form-control" id="variacao" placeholder="" required> <br/>
                  
                 
                </div>
       <div name="alimentos" >
                    <label style="padding:0.4%"> Alimento indicado 2: </label> 
                    <input  type="text" class="form-control" id="alimentos" placeholder="Ex: Banana, uva..." required> <br/>
  
                </div>
     
      <div name="porção" >
                    <label style="padding:0.4%"> Porção ideal 2: </label> 
                    <input  type="number" class="form-control" id="qtd" placeholder="" required> <br/>
      ...
      <div name="variação" >
                    <label style="padding:0.4%">Variações do alimento 2: </label> 
                    <input  type="text" class="form-control" id="variacao" placeholder="" required> <br/>
            ...
            <tr>
                ...
                <td>adicional de banana</td>
				   <td rowspan="3"> <button type="submit"  class="btn btn-success">Editar</button> 
                     <button type="submit"  class="btn btn-danger" data-toggle="modal" data-target="#myModal2">Excluir</button> </td>
            </tr>
             <tr>
