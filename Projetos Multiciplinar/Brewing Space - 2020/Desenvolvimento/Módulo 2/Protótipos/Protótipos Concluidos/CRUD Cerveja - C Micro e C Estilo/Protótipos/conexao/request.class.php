...
class Receita {
	...
	public function infoMicrocervejaria($id) { //Coleta todas as informações do usuario
	...
	public function getIdMicrocervejaria($id) { //Coleta todas as informações da microcervejaria
