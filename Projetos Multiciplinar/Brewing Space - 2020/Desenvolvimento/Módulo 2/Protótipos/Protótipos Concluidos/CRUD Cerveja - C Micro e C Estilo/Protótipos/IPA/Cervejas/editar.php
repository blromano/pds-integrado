...
$cerveja = $conexao->infoCerveja($id_cerveja);
        ...
        <main>
            <div class="container content-main">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="edt.php?id=<?php echo $id_cerveja ?>">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputNome">Nome da Cerveja</label>
                                    <input type="text" class="form-control" name="nome" value="<?php echo $cerveja->CER_NOME?>" required autofocus>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="inputCpf">Estilo</label>
                                    <select class="form-control" name="estilo" required>
                                        <?php
                                        $estilos = $conexao->listEstilos();

                                        foreach ($estilos as $key => $value) {
                                            echo "<option>$value->EST_NOME</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
