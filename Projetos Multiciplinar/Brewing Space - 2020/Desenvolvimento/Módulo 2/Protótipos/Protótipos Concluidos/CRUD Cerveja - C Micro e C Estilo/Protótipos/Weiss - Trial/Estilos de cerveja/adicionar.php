                        ...
                        <form method="POST" action="adc.php">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="abv_min" required>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">ABV Max</label>
                                    <input type="text" class="form-control" id="inputEmail4" name="abv_max" required>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">EBC Min</label>
                                    <input type="text" class="form-control" name="ebc_min" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">EBC Max</label>
                                    <input type="text" class="form-control" name="ebc_max" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">IBU Recomendada</label>
                                    <input type="text" class="form-control" name="ibu_rec" required>
                                </div>
