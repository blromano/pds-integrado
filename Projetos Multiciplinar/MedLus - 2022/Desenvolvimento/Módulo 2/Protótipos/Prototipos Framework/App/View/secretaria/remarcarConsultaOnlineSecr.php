<?php 
    $pagina = "remarcarConsultaOnline(secr)";
    $footerColado = False;
    include "../config.php";
    include '../header.php';
...
?>
    <section class="d-flex flex-column align-items-center">
        <h2 class="main-title mt-2">Remarcar Consulta Online</h2>
        <section class="bg-white mt-5 mb-5 listagem d-flex align-items-center flex-column px-5 col-md-6 col-sm-12 col-lg-3">
            ...
            <div class="py-5 data">
                ...
                <br/>
                    ...
                    <a href="../consulta/consultasOnlineConfirmadas.php" class="btn btn-sm btn-primary">Cancelar</a>
