...
<body>
    <div class="d-flex flex-column align-items-center conteudo">
        ...
        <form action="" method="POST" class="col-sm-12 col-md-6 col-lg-5 mb-5">
            <h3>Cadastro Enfermeiro(a)</h3>
    
            <label for="username">Inscrição - COREN</label>
            <input type="text" placeholder="COREN - [Estado] - [Número de inscrição] - [Categoria]" id="nome"></br>
