...
include '../../MVC/controle/LocalizacaoDAO.php';
$local = new LocalizacaoDAO();

include '../../MVC/controle/ConsumidorDAO.php';
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">   
			...
			<li class="scroll" style="cursor:pointer"><a data-toggle="modal" data-target="#modal-login">Logar</a></li>  
...
-->
      <div class="modal-footer" align="center">
					<button class="btn btn-default" type="submit" onclick="location.href='mod01-loginUsuario.html'".click();>Consumidor</button>
      ...
      <div class="container">
        ...
        <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="row">
           ...
           <form action="../../MVC/visao/Usuarios/cadastrarUsuario.php" method="POST">
            <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
				...
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6" style="padding-left: 20px;">
                    <div class="form-group">
                      <input type="text" name="cpf" class="form-control" id="cpf"; placeholder="CPF (SOMENTE NÚMEROS)" required="required" maxlength="14" onblur="return verificarCPF(this.value)" OnKeyPress="formatar('###.###.###-##', this)">
					  <p id="cpfReslt"> </p>
                    </div>
                  </div>
				  <div class="col-sm-6" style="padding-right: 20px;">
                    <div class="form-group">
                      <input type="text" name="cep" class="form-control" id="cep"; placeholder="CEP" OnKeyPress="formatar('#####-###', this)" onblur="pesquisacep(this.value);" required="required" pattern=".{0}|.{9,9}" maxlength="9" oninvalid="setCustomValidity('Por favor, informe um CEP válido.')" onchange="try{setCustomValidity('')}catch(e){}">
                    </div>
                  </div>
                </div>
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6" style="padding-left: 20px;">
                    <div class="form-group">
                      <input onkeyup="validaSenha();" type="password" name="senha" id="senha" class="form-control" placeholder="Senha" required="required">
					  <p id="resultado"> </p>
                    </div>
                 </div>
                 <div class="col-sm-6" style="padding-right: 20px;">
                    <div class="form-group">
                      <input onkeyup="validaSenha();" type="password" name="confirmar_senha" id="confirmar_senha" class="form-control" placeholder="Confirmar Senha" required="required">
                    </div>
                  </div>
                </div>
				<div class="form-group">
				...
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6" style="padding-left: 20px;">
                    <div class="form-group">
                      <input type="text" name="rua" id="rua" class="form-control" placeholder="Rua" required="required" oninvalid="setCustomValidity('Por favor, digite a rua do consumidor')" onchange="try{setCustomValidity('')}catch(e){}">
                    </div>
                  </div>
                  <div class="col-sm-6" style="padding-right: 20px;">
                    <div class="form-group">
                      <input type="text" name="bairro" id="bairro" class="form-control" placeholder="Bairro" required="required" oninvalid="setCustomValidity('Por favor, digite o bairro do consumidor.')" onchange="try{setCustomValidity('')}catch(e){}">
                    </div>
                  </div>
                </div>
					<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6" style="padding-left: 20px;">
                    <div class="form-group">
                      <input type="number" name="numero" class="form-control" placeholder="Número" required="required">
                    </div>
                  </div>
                  <div class="col-sm-6" style="padding-right: 20px;">
                    <div class="form-group">
				...
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6" style="padding-left: 20px;">
                    <div class="form-group">
                      <input type="text" name="estado" id="estado" class="form-control" placeholder="Estado" required="required" oninvalid="setCustomValidity('Por favor, digite o estado do consumidor.')" onchange="try{setCustomValidity('')}catch(e){}">
                    </div>
                  </div>
                  <div class="col-sm-6" style="padding-right: 20px;">
                    <div class="form-group">
                      <input type="text" name="cidade" id="cidade" class="form-control" placeholder="Cidade" required="required" oninvalid="setCustomValidity('Por favor, digite a cidade do consumidor.')" onchange="try{setCustomValidity('')}catch(e){}">
                    </div>
                  </div>
                </div>
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6" style="padding-left: 20px;">
                    <div class="form-group">
                      <input type="text" name="telefone" class="form-control" placeholder="Telefone (SOMENTE NÚMEROS)" required="required" maxlength="11">
                    </div>
                  </div>
                  <div class="col-sm-6" style="padding-right: 20px;">
                    <div class="form-group">
                      <input type="text" name="telefone2" class="form-control" placeholder="Telefone 2 (SOMENTE NÚMEROS)" maxlength="11">
                    </div>
                  </div>
                </div>
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6" style="padding-left: 20px;">
                    <div class="form-group">
                     <input type="date" name="data_nascimento" class="form-control" placeholder="Data de Nascimento" required="required">
                    </div>
                  </div>
					<div class="col-sm-6" style="padding-left: 20px;">
						<div class="form-group">
						  <input class="from-control" name="foto_perfil" type="file" accept="image/*;capture=camera">
						</div>
					</div>
				</div>
                                     
                <div class="form-group" style="margin-bottom: 0px;">
                   <button type="submit" class="btn-submit2" dtype="submit"; >Confirmar</button>
                </div>
              </form>   
...
<script type="text/javascript" src="../../js/mod01/verificarSenha.js"></script>
<script type="text/javascript" src="../../js/mod01/verificarCPF.js"></script>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<script language="JavaScript" type="text/javascript" src="js/verificarCPF.js"></script>
