			...
			<div class="carousel-inner">
				<div id="itema" class="item active" style="background-image: url(images/slider/1.jpg); background-size:cover; back:no repeat; background-attachment:fixed;height:100vh;background-position:center center;">
						...
						<div class="container">
							...
							<div class="col-md-6">
								<span class="pull-right">
									<div class="dropdown">
									  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> José
									  ...
									  <ul class="dropdown-menu">
										...
										<li><a href="../comum/Template/index.html"><span class="glyphicon glyphicon-off"></span> Sair</a></li>
									  </ul>
									  <i><a href="mod01-chatUsuario.html" style="font-size:28px; margin-left:45px" class="fa fa-comments" aria-hidden="true"></a></i>
									  <p class="chat" style="font-size:12px; margin-left:130px"><b>CHAT</b></p>
									</div>
								  </span>
							</div>
						</div>
					...
					<div class="caption">
						...
						<h1 class="animated fadeInLeftBig">Bem Vindo </br><span>José</span></h1>
            ...
            <span class="icon-bar"></span>
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="../../mod01_usuarios/mod01-duvidasFrequentes.html">Dúvidas</a></li>
...
-->
      <div class="modal-footer">
					<button class="btn btn-default" type="submit" onclick="location.href='../../mod01_usuarios/mod01-loginUsuario.html'".click();>Usuário</button>
