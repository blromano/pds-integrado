...
-->
      <div class="modal-footer" align="center">
					<button class="btn btn-default" type="submit" onclick="location.href='mod01-loginUsuario.html'".click();>Usuário</button>
      ...
      <div class="container">
        <div class="row">
          <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <h2>Cadastre-se como Usuário</h2>
           ...
           <form action="cadastrarUsuario.php" method="POST">
            <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
				...
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                 ...
                 <div class="col-sm-6" style="padding-right: 20px;">
                    <div class="form-group">
                      <input type="password" name="confirmar_senha" class="form-control" placeholder="Confirmar Senha" required="required">
                    </div>
                  </div>
                </div>
				<div class="form-group">
				...
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6" style="padding-left: 20px;">
                    <div class="form-group">
                      <input type="text" name="telefone1" class="form-control" placeholder="Telefone 1" required="required">
                    </div>
                  </div>
                  <div class="col-sm-6" style="padding-right: 20px;">
                    <div class="form-group">
                      <input type="text" name="telefone2" class="form-control" placeholder="Telefone 2">
                    </div>
                  </div>
                </div>
				<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
