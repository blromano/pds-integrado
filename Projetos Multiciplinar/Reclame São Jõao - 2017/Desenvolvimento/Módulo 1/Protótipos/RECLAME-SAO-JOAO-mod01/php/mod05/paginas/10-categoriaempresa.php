            ...
            <div class = "modal-dialog" >
                <div class = "modal-content" >
                    ...
                    <div class = "modal-body" >
                        <form action = "paginas/gerenciamento/controle_TiposEstabelecimento/update_TiposEstabelecimento.php" method = "post" >
                            <ul class = "list-group" >
                                <li class = "list-group-item" > Nome: 
                                    <span class = "pull-right"> 
                                        <input type = "text" name = "nomeup" id="nomeup" class = "form-control" > 
                                    </span>
                                </li >
        ...
        <div id = "remover" class = "modal fade" role = "dialog" >
            <div class = "modal-dialog" >
                <div class = "modal-content" >
                    ...
                    <div class = "modal-body" >
                        <form action = "paginas/gerenciamento/controle_TiposEstabelecimento/deleta_TiposEstabelecimento.php" method = "post" >
                            <ul class = "list-group" >
                                <li class = "list-group-item" >
                                    <p> Você tem certeza que deseja excluir o categoria: <span  id="nomedel"></span></p>
        ...
        <div id = "add" class = "modal fade" role = "dialog">
            <div class = "modal-dialog" >
                <div class = "modal-content" >
                    ...
                    <div class = "modal-body" >
                        <form action = "paginas/gerenciamento/controle_TiposEstabelecimento/add_TiposEstabelecimento.php" method = "post" >
                            <div class = "form-group" >
                                <label for = "nome" > Nome da nova categoria: </label>
                                <input type = "nome" class = "form-control" id = "nomeadd" name = "nomeadd" >
                            </div>
