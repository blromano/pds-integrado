<?php
	...
	$registro = $ConsumidoresDAO->listar();
?>
<script>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="paginas/gerenciamento/Consumidores/editarConsumidores.php" method="post" data-toggle="validator" role="form">
...
<div id="remover" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="paginas/gerenciamento/Consumidores/removerConsumidores.php" method="post">
