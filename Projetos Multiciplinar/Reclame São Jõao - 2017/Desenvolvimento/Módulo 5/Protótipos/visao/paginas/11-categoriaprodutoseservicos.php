	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action = "paginas/gerenciamento/TiposProdutoseServico/update_TiposProdutoseServico.php" method = "post" data-toggle="validator" role="form" >
					<ul class="list-group">
...
<div id="remover" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action = "paginas/gerenciamento/TiposProdutoseServico/deleta_TiposProdutoseServico.php" method = "post" >
					<ul class = "list-group" >
						<li class = "list-group-item" >
...
<div id="add" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action = "paginas/gerenciamento/TiposProdutoseServico/add_TiposProdutoseServico.php" method = "post" data-toggle="validator" role="form" >
					<div class="form-group">
