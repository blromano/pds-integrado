...
<head>
	...
	<link href="css/usu_login.css" rel="stylesheet">
...
<button class="usu_paginaBoasVindasUsuario.php"type="submit">Login</button>
...
<body>
  ...
  <!-- Modal escolher forma de cadastro (usuário / estabelecimento)-->
	...
	-->
		  <div class="modal-footer" align="center">
						<button class="btn btn-default" type="submit" onclick="location.href='usu_cadastroUsuario.php'".click();>Usuário</button>
 ...
 <section id="contact">
    ...
    <div id="contact-us" class="parallax">
      <div class="container">
        <div class="row">
          <div style="margin-bottom: 0px; padding-bottom: 0px;" class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <h2>Faça seu login</h2>
            <p>Entre com seu email e senha para poder acessar todo o conteudo do site!</p>
          </div>
        ...
        <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
		  ...
		  <?php if(isset($_SESSION['cadastroValidado'])){
				echo $_SESSION['cadastroValidado'];
				unset($_SESSION['cadastroValidado']);
			}?>
		  </p>
		  <p style="text-align:center;color:green;">
		  ...
		  <p class="text-center text-danger">
		   ...
		   <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
					<div class="row">
              ...
              <form id="main-login-form" name="login-form" action="php/mod01/loginUsuario.php" method="POST"  ;
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type="email" name="USU_EMAIL" class="form-control" placeholder="Email" required="required">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type="password" name="USU_SENHA" class="form-control" placeholder="Senha" required="required">
                    </div>
                  </div>              
                
				
				<p class="text-center"><a class="recuperarSenha" href="usu_emailRecuperarSenha.php"> Clique aqui </a>para recuperar sua senha</p>                         
                <div class="form-group" style="margin-bottom: 0px; margin-left: -2%; margin-right: -2%;">
                   <button type="submit" class="btn-submit2" dtype="submit"; >Entrar</button>
                </div>
...
<!--Modal sucesso cadastro-->   
	<div class="modal fade" id="modal-cadastro_sucesso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-sm" role="document">
		<div class="modal-content modal-sm">
		  <div class="modal-header modal-sm">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="myModalLabel" style="text-align: center;">Cadastro realizado com sucesso!</h4>
		  </div>
		  <div class="modal-footer" align="center">
...
if(isset($_GET['cadastro'])){		
		echo "<script> $('#modal-cadastro_sucesso').modal('show') </script>";
	} 		
?>
