      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right" style="height: 80px;">   
			<li class="scroll active"><a href="#team">Sobre Nós</a></li>
    ...
    <div class="container">
      <div class="row" style="margin-top: -11%;">
        <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1200ms" data-wow-delay="300ms">
          <h2 style="margin-top: 25%;">Quem somos?</h2>
          <p style="margin-bottom: -5%;">Uma equipe de alunos do IFSP - SBV focados em concluir o projeto, cada um cumprindo sua função básica:<br>Analistas - Administradores de Banco de Dados - Desenvolvedores.</p>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="member-image">
				...
				<!-- Link para acessar currículo <iframe src="http://devsa.info/teste.pdf" width="600" height="780" style="border: none;"></iframe> -->
              </div>
              <div class="member-info">
                <h3>Breno Lisi &amp; Luiz Angelo</h3>
                <h4>Idealizadores</h4>
                <p>Atualmente professores na instituição que buscam o máximo dos alunos</p>
              </div>
              <div class="social-icons" style="margin-top: 11%;">
                <ul>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="500ms">
              ...
              <div class="member-info">
                <h3>Desenvolvedores e Testadores</h3>
                <h4>Front-End &amp; Back-End</h4>
                <p>Buscam pela integração e teste das funções do Sistema</p>
              </div>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="800ms">
              ...
              <div class="member-info">
                ...
                <h4>Analista &amp; Documentação</h4>
                <p>Criam planos e documentação para o seguimento do Sistema</p>
              </div>
              <div class="social-icons" style="margin-top: 11%;">
                <ul>
                  <li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="1100ms">
              ...
              <div class="member-info">
                <h3>Analistas de Banco de Dados</h3>
                <h4>Support Manager</h4>
                <p style="">Realizar a análise e manutenção do Banco de Dados</p>
              </div>
              <div class="social-icons">
                <ul>
                  <li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
