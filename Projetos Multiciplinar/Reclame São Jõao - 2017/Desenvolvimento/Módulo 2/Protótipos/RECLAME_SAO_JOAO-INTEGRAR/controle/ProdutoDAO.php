...
class ProdutoDAO {
	...
	{
        $this->post = $post;
        $this->sql = "insert into $this->tabela (PDT_NOME, PDT_DESCRICAO_PRODUTO, EST_ID, TRP_ID) values (:PDT_NOME,:PDT_DESCRICAO_PRODUTO, :EST_ID, :TRP_ID)";
		...
		$this->resultado->bindParam(':TRP_ID', $this->post->getTRP_ID());
	...
	{
        $this->post = $post;
        $this->sql = "update $this->tabela set PDT_NOME =:PDT_NOME, PDT_DESCRICAO_PRODUTO=:PDT_DESCRICAO_PRODUTO, TRP_ID=:TRP_ID where PDT_ID =:PDT_ID";
