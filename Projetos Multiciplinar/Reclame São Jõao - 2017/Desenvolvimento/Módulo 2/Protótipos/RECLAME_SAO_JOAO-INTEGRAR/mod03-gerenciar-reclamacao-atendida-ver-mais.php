...
<?php
	...
	//Selecionando todos os dados da tabela Resposta Reclamação
		include_once("../../MVC/visao/Reclamacoes/conexao.php");
		$result_respostas = "SELECT * FROM respostas_reclamacoes where RER_ID = 1";
	...
	<body>
		...
		<section id="contact" style="margin-top: 3%;">
			...
			<div class="forma">
						...
						<div class="container" style="margin-top: 2.5%;">
							<div>
								...
								<!-- REDIRECIONAR PARA A PÁGINA: AGENDAR REUNIÃO -->
									<a href="mod03-agendar-reuniao.html" class="agendar-reuniao" style="margin-left:1%;">Agendar Reunião</a>
				...
				<!-- INÍCIO DO  RESPOSTA - COMENTÁRIO 3 -->
						<div class="container" style="margin-top: 2.5%;">
							<div>
								<!-- TÍTULO DO COMENTÁRIO -->
								<?php foreach($registro as $linha) { ?>
				...
				<!-- FIM DO RESPOSTA - COMENTÁRIO 3 -->
				
				<!-- INÍCIO DO  RESPOSTA - COMENTÁRIO 4 -->
						<div class="container" style="margin-top: 2.5%;">
							<div>
								<!-- TÍTULO DO COMENTÁRIO -->
								<?php foreach($registro as $linha) { ?>
				...
				<!-- FIM DO RESPOSTA - COMENTÁRIO 4 -->
			  
				<!-- PÁGINA -->
				   <ul class="pagination pull-right">
					  <li><a href="mod03-gerenciar-reclamacao-atendida.php">1</a></li>
			...
			<div id="EXCLUIR-RESPOSTA" class="modal fade" role="dialog">
			  <div class="modal-dialog">
						<div class="modal-content">
							<form method="POST" action="http://localhost/Template2/MVC/visao/Reclamacoes/excluirRespostas.php" enctype="multipart/form-data">
						...
						<div class="modal-header">	
						 ...
						 <div class="modal-footer">
							<input  type="hidden" id="RER_ID" name="RER_ID" class="form-control" id="recipient-numero-resposta">
							<button type="submit" class="btn btn-default pull-left" data-dismiss="modal">Confirmar</button>
		...
		<!-- RODAPÉ -->
			<footer id="footer" style="background-color: #232323; margin-bottom: -10%; margin-top: 8%;" >
			    ...
			    <div class="modal fade" id="RESPOSTA" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form method="POST" action="http://localhost/Template2/MVC/visao/Reclamacoes/editarRespostas.php" enctype="multipart/form-data">
											
											<div class="form-group">
												<label for="recipient-titulo" class="control-label">Título:</label>
												<textarea name="REC_TITULO_RECLAMACAO" type="text" id="recipient-titulo" style="width: 570px; height: 50px; margin-left:0%;" disabled></textarea>
											</div>
											<div class="form-group">
											...
											<input name="RER_ID" type="hidden" id="qualquer">
											<div class="modal-footer">
