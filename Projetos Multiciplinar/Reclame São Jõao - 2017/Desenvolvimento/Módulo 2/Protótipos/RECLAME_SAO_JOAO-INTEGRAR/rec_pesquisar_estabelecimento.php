   ...
   <body style="background: #f4f3f0;">
      ...
      <center>
         <table border="0" style="margin-top: 12%;">
            <tr>
               <td class="loucura2">Encontre o estabelecimento <br/>para fazer sua reclamação:</td>
            </tr>
         </table>
      </center>
      <center>
         <table border="0" style="margin-top: 2%;">
            <tr>
               <td><span style="font-size: 30px;" class="glyphicon glyphicon-fire"></span></td>
            </tr>
         </table>
      </center>
      <center>
            ...
            <div class="divbarraetitulo">
               <table border="0" class="tableunica">
                  <form style="color: black;" action='rec_estabelecimento.php' method='get'>
                     ...
                     <tr>
                        <td><a href="ava_formulario.php"><button type="submit" name="destination-submit"  class="botao"  onclick="location.href='rec_estabelecimento.php'".click()>Pesquisar</button></a></td>
                     </tr>
