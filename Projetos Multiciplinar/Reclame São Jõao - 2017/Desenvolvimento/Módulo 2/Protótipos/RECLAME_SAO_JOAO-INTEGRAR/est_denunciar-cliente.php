...
<html lang="en">
	...
	<body>
	   ...
	   <!-- MENU DO SITE -->
		  ...
		  <div class="container">
				...
				<div class="collapse navbar-collapse">
				  <ul class="nav navbar-nav navbar-right">   
					<li class="scroll active"><a href="#contact">DENUNCIAR CLIENTE</a></li>
	    ...
	    <!-- CORPO DA PAGINA DENUNCIAR CLIENTE -->
			<section id="contact">
				  ...
				  <div class="container">
					...
					<div class="row">
					  <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
						...
						<p>Página destinada a denúncias sobre um comentário inadequado de um cliente!</p>
					  </div>
					</div>
					  ...
					  <div class="row">
						<div class="col-sm-6 " style="width: 60%; margin-right:20%; margin-left:20%; ">
						  <form id="main-contact-form" name="contact-form" method="post" action="#" style="border: 1px solid white; padding: 15px; 30px 0px;">
							...
							<!-- OPÇÕES DE DENPUNCIAS DE CLIENTE -->
							<div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
								  
									  <div class="col-sm-6" style="padding-left: 20px;">
										<div class="form-group">
											<input type="radio" name="opcoes" value="html"/> Comportamento violento ou negativo<br />
											<input type="radio" name="opcoes" value="html"/> Spam ou Fraude<br />
											<input type="radio" name="opcoes" value="html"/> Discurso de violência<br />
										</div>
									  </div>

									  <div class="col-sm-6" style="padding-left: 20px;">
										<div class="form-group">
											<input type="radio" name="opcoes" value="html"/> Conteúdo sexualmente explícito<br />
											<input type="radio" name="opcoes" value="html"/> Outros motivos<br />
										</div>
									  </div>
							</div>
										...
										<div class="col-sm-6" style="padding-left: 20px;">
											<div class="form-group">	  
												<fieldset>
													...
													<textarea class="textarea4" name="descricaoprodutos" rows="5" cols="90" placeholder="Mensagem" style="resize: none;"></textarea>
												</fieldset>
											</div>
										</div>
							</div>
