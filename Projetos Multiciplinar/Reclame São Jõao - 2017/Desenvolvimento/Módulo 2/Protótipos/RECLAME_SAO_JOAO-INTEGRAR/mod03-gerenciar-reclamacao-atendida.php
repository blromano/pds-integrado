...
<?php
	//Criar conexão com a tabela Reclamação
		...
		$registro = $RECLAMACOESdao->pesquisarPorId('3');
	
	//Criar conexão com a tabela Usuários
		include '../../MVC/controle/UsuarioDAO.php';
		$USUARIOdao = new UsuarioDAO();
		$registro_usuario = $USUARIOdao->pesquisarPorId('3');
	...
	//Criar conexão com a tabela Resposta da Reclamação
		...
		$registro_respostas = $RESPOSTARECLAMACAOdao->pesquisarPorId('3');
				...
				<!-- INÍCIO DO  RESPOSTA - COMENTÁRIO 2 -->
						<div class="container" style="margin-top: 2.5%;">
							<div>
								...
								<!-- PONTUAÇÃO POR ESTRELAS -->
									<div class="estrelas">
								     <?php $nt = new Reclamacoes();
										if($nt->getREC_NOTA()==1){ ?>
										  <input type="radio" id="cm_star-empty" name="fb" value="" checked/>
										  <label for="cm_star-1"><i class="fa"></i></label>
										<?php }
										else if($nt->getREC_NOTA()==2){ ?>
										  <input type="radio" id="cm_star-empty" name="fb" value="" checked/>
										  <label for="cm_star-1"><i class="fa"></i></label>
			  ...
			  <div class="modal fade" id="RESPOSTA" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form method="GET" action="../../MVC/visao/Reclamacoes/editarRespostas.php">
