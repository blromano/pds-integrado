                    ...
                    <center>
                      ...
                      <form style="width: 100%">
                        ...
                        else 
                        {
                          ...
                          <select style="width: 100%" name = "reclamação">
                            <?php foreach($registro as $linha) { ?>     
                            <option value="<?php echo $linha['REC_ID'];?>"><?php echo utf8_encode($linha['REC_DESCRICAO']);?></option>          
                            <?php }?> 
                          </select>
                          <br />
                          <br />
                          <p style="float:left">Assunto Pautado:</p>
                          <br /><textarea style="width: 100%" type="text" name="assuntopautado" /> </textarea> 
                          <br />
                          <br />
                          <p style="float:left">Status de Soluções:</p>
                          <br /><input style="width: 100%"type="text" name="statusdesoluçoes" /> 
                          <br />
                          <br />
                          <br />
                          <br />
