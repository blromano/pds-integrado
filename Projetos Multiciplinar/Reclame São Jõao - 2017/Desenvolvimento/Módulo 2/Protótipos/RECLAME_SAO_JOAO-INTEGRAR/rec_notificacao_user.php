...
<!--
<br/>
<p class="titulosolucao">Consideração final do Consumidor: </p>

<p class="loucura33">Escreva sua consideração</p>
<textarea rows="20" cols="70" class="nomeMenu3334" placeholder="Escreva aqui todos os detalhes da sua consideração final..." maxlength="500"></textarea>

-->
<p class="loucura33">Seu problema foi resolvido</p>
<form action=""><p class="consideracaotexto">
  <input type="radio" name="gender" value="male"> Sim<br>
  <input type="radio" name="gender" value="female"> Não<br>
  <input type="radio" name="gender" value="other"> Indiferente</p>
</form>
<p class="loucura33">Agenda reunião</p>
<form action=""><p class="consideracaotexto">
  <input type="radio" name="gender" value="male"> Sim<br>
  <input type="radio" name="gender" value="female"> Não<br>
</form>
<p class="loucura33">Telefone Empresa:</p>
<p class="loucura33" >(19) 3622-3767 </p>
...
<a href="index.php"><button type="submit"  class="enviarreclame3334">Voltar ao menu principal</button></a>
</div>
</div>
