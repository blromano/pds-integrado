                ...
                <form class="formLogin" action="verificarlogin.php" method="POST" id="form-login" >
                    <div class="row control-group">
                        ...
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            <label>Email</label>
                            <input name="email" type="email" class="form-control entrada-texto"  pattern="^[_A-z0-9@./\-/]{1,}$" placeholder="Email" value="<?php echo $logado?>">
                        </div>
                    </div>
                    <div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            <label  maximum length 4:>Senha</label>
