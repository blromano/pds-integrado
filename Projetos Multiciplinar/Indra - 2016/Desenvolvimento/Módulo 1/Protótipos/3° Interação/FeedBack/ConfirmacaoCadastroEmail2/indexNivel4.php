...
require_once 'class/UsuarioLogin.php';
session_start();
				...
				<table id="gerenciamento" align="center"  class="table table-condensed">
					  <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><font>Comunicados</font></td>
                                    <td><button class="btn btn-primary btn-table " data-dismiss="modal" data-toggle="modal" >gerenciar</button></td>
                                </tr>
                                <tr>                                   
                                    <td><font>FeedBack </font></td>
                                    <td><a id="link-gerenciamento" href="GerenciarFeedBack.php" class="btn btn-primary btn-table " >Gerenciar</a></td>
                                </tr> 
                            </tbody>
