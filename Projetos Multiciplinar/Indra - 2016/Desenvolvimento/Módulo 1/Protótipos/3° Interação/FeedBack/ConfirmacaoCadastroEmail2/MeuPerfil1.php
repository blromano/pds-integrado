...
if (!isset($_SESSION['user'])) {
    ...
    if (($_SESSION['user']->getNivelAcesso() != 1) && ($_SESSION['user']->getNivelAcesso() != 2) && ($_SESSION['user']->getNivelAcesso() != 3) && ($_SESSION['user']->getNivelAcesso() != 4)) {
            ...
            <div id="modal-editar-cadastro" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">  
                            <form  class="form_alterar_cadastro" method="post" action="AlterarCadastroUsuario.php" novalidate id = "form_alterar_cadastro">
                                <div  class="row">
                                    <div class="col-lg-12">
...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Complemento" name="USU_COMPLEMENTO" value="<?php echo $_SESSION['user']->getComplemento();?>" required >
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-lg-12">
        <div>
            <label> Leia os Termos de Uso</label>
            <a style="font-size: 11px; margin-left: 0.3%; color: #4682B4" >
                Saiba mais
            </a>
        </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div>
            ...
            <input  type="submit" role="button" value="Editar" class="btn btn-primary" disabled></input>
        </div>
    </div>
</div>
<div class="row">
...
<section  id="funcionalidades">
    <div class="container elemento-expandido">
        ...
        <script src="js/validatorRecuperarSenha.js"></script>

        <script src="js/validatorAlterarCadastro.js"></script>
