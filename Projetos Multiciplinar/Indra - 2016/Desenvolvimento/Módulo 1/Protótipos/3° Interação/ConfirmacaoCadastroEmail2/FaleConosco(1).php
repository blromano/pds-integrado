...
<body id="page-top" class="index">
    ...
    <!-- About Section -->
        ...
        <section class="success" id="about">
            <form class = "cadastrar_feedback" method="post" action="CadastrarFeedBack.php" novalidate id = "cadastrar_feedback">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2> Fale Conosco </h2>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <br></br>
                        <select class="form-control select" name = "FEE_TOPICO">
                        ...
                        <br></br>
                        <label for="comment">Digite sua mensagem:</label>
                        <textarea id="comment" class="form-control" rows="5" style="width: 100%" name = "FEE_MENSAGEM"></textarea>
                    </div>
