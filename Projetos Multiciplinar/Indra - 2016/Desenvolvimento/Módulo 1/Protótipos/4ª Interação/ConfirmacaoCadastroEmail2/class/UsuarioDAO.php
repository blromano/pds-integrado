...
class UsuarioDAO {
    ...
    public function criarUsuario($usuario) {
        try {
            ...
            $query = "INSERT INTO USUARIOS (USU_NOME, USU_CIDADE, USU_ID, USU_DATA_NASCIMENTO, USU_EMAIL, USU_SENHA, USU_DATA_ATIVACAO, USU_CODIGO_ATIVACAO, USU_RUA, USU_DATA_RECUPERACAO_SENHA, NIV_ID, USU_STATUS_ATIVACAO, USU_NUMERO_RESIDENCIA, USU_CEP, USU_COMPLEMENTO) VALUES(:USU_NOME, :USU_CIDADE, :USU_ID, :USU_DATA_NASCIMENTO, :USU_EMAIL, :USU_SENHA, :USU_DATA_ATIVACAO, :USU_CODIGO_ATIVACAO, :USU_RUA, :USU_DATA_RECUPERACAO_SENHA, :NIV_ID, :USU_STATUS_ATIVACAO, :USU_NUMERO_RESIDENCIA, :USU_CEP, :USU_COMPLEMENTO)";
            $stmt = $db->prepare($query);
            $stmt->bindValue(":USU_NOME", $usuario->getNome(), PDO::PARAM_STR);
            $stmt->bindValue(":USU_CIDADE", $usuario->getCidade(), PDO::PARAM_STR);
            ...
            $stmt->bindValue(":NIV_ID", $usuario->getNivId(), PDO::PARAM_STR);
    ...
    public function LoginCadastro($codigo) {
        try {
            $db = Database::conectar();
            $query = "SELECT * FROM usuarios WHERE USU_CODIGO_ATIVACAO = :codigo ";
            $stmt = $db->prepare($query);
