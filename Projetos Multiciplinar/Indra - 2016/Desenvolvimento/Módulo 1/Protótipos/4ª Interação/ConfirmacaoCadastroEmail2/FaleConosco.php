...
<body id="page-top" class="index">
    ...
    <!-- About Section -->
        ...
        <section class="success" id="about">
            <form class = "cadastrar_feedback" name ="cadastrar_feedback"  method="post" action="CadastrarFeedBack.php" novalidate id = "cadastrar_feedback" onsubmit="return validaForm()" >
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2> Fale Conosco </h2>
