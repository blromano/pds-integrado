...
<html lang="pt-br">
    ...
    <body id="page-top" class="index">
        ...
        <div id="modal-login" class="elemento-escondido">
            <form class="formLogin" action="verificarlogin.php" method="POST" id="form-login" >
                ...
                <div class="row control-group">
                    <div class="form-group col-xs-12 floating-label-form-group controls">
                        <label maxlength="40">Senha</label>
                ...
                <div class="form-group col-xs-12" id="cadastrar">
                    ...
                    <a style="color:Darkblue"; data-toggle="modal" href="#modalRec" id="btn-recuperar">Esqueci minha senha.</a>  
...
<div class="modal fade" id="modalRec" tabindex="1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="formRecuperacao" action="RecuperarSenha.php" method="POST" novalidate id="formRecuperacao">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="EMAIL" name="rec_email" required>
                    </div>

                </div>
                <div class="modal-footer">
                    <input  type="submit" role="button" value="Enviar" class="btn btn-primary" disabled ></input>
                </div>
            </form>
        </div>
    </div>
