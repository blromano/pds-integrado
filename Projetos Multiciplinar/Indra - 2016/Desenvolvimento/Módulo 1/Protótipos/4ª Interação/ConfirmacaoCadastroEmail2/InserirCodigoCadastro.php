                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="float:right">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="page-scroll">
                                <a href="#">Confirmação de Cadastro</a>
                            </li>
                           >
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-offset-2">
                            <p>Sua Conta foi ativada com sucesso. Obrigado por se cadastrar no portal INDRA ;)</p>
                            <p>Clique aqui para ir a página inicial: </p>
                            <a href="indexNivel2.php"  style="color:white;"  type="button" class="btn btn-default"> Página Inicial </a>
