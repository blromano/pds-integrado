    ...
    <body id="page-top" class="index">
        ...
        <section id="contact">
            <div class="container" >
                <br>
                <h3>Cadastro</h3>
                <form data-toggle="validator" action="cadastrar_usuario.php" name="form_Cadastro">
                    ...
                    <div class="form-group">					
                        <label>Estado:</label>
                        <div>
                            <select style="float: left; width: 18%" class="form-control" required name="estado">
                    ...
                    <div class="form-group">					
                        ...
                        <div>
                            <select style="float: left; width: 18%" class="form-control" required name="tipo_usuario" onchange="mostrar_formulario(this.value);">
                    ...
                    <div>
                        <br>
                        <input  type="submit" role="button" value="Cadastrar" class="btn btn-primary">aaa</input>
                    </div>
                </form>
            </div>    
        </section>
