...
<html lang="pt-br">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
						...
						<form >
                            ...
                            <input type="button"  role="button" value = "Sim" class="btn btn-primary" id="input-sim-excluir-modal" data-dismiss="modal">
            ...
            <div class="modal fade" id="editar-pcd-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
					...
					<div class="form-group ">
                        ...
                        <div class="modal-footer">
                            <input type="button" role="button" value="Salvar" class="btn btn-primary btn-salvar" id="input-salvar-edicao-modal" data-dismiss="modal"></input>
	...
	<script type="text/javascript">	
        ...
        <script src="js/table/table/tables.js"></script>
