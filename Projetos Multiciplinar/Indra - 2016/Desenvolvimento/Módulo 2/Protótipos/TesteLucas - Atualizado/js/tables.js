$(document).ready(function() { 
    ...
    //Configuração do DataTables da página de controle de funcionalidades - controledefuncionalidades.html -Lucas
$('#lista-tiposensor').DataTable({
        lengthChange: false,
        "language": {
        	"lengthMenu": "Mostrando _MENU_ itens por página",
        	"zeroRecords": "Nenhum item encontrado.",
...
$('#lista-status tbody').on('click', 'button', function(){
		...
		$('#input-status-pcd').val($(this));
		$('#input-id-pcd-habilitar').val($(this).val());
		$('#input-status-pcd-habilitar').val($(this).val());
	});
