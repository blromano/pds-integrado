...
<html lang="pt-br">
    ...
    <body id="page-top" class="index">
		...
		<!--MODAL EXCLUIR-->
            ...
            <div class="modal fade" id="controle-defuncionalidade-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
					<form>
						<div class="modal-header">
                             <h3>Controle de Funcionalidade</h3>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
										...
										<div>
											<input type="checkbox" id="valida_alteracao" name="valida_alteraracao1" value="valida_alteracao2" required>Tem certeza que deseja alterar o status da pcd?<br>
									</div>     
									</div>                    
                        </div>
                        <div class="modal-footer">
                            <input type="submit" id="salvar_alteracao" role="button" value="Salvar" class="btn btn-primary">
						<input type="submit" role="button" value="Cancelar" class="btn btn-primary">
                        </div>
        ...
        <section id="contact" >
            <div class="container elemento-expandido" ><br><br>                           
                    <div>
                        ...
                        <table id="lista-status" class="table table-condensed" style="width:30%;margin-left:35%;">
                            <thead>
                                <tr bgcolor="#3a4857">
                                    <th style="width:30%">PCD</th>
                            ...
                            foreach ($value as $value):
								...
								<?php	if($value->getPCD_STATUS_FUNCIONAMENTO() > 0){
											echo "<td><button class='btn btn-primary btn-table'> Desabilitar </button></td>";
										}
										else{
											echo "<td><button class='btn btn-primary btn-table'> Habilitar</button></td>";
											} ?>
                                </tr>
                                <?php
                            endforeach;
       ...
       <!-- Plugin JavaScript -->
		...
		<script src="js/Listagem funcionalidade.js"></script>
