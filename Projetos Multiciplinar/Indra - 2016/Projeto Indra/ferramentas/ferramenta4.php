        ...
        <body id="page-top" class="index">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="float:right">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="hidden">
                                <a href="../indra/mod01/indexNivel1.php"></a>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" id="drop-menu" role="menu">
                                    <li role="presentation"><a href="../ferramenta1.php" >Ferramenta 1</a></li>
                                    <li role="presentation"><a href="../ferramenta2.php" >Ferramenta 2</a></li>
                                    <li role="presentation"><a href="../ferramenta3.php" >Ferramenta 3</a></li>
                                    <li role="presentation"><a href="../ferramentaUser5.php" >Ferramenta 5</a></li>
                                </ul>
                            </li>
                            <li id="btn-login">
            ...
            <header id="painel-inicial">
                <div class="container" >
                    <div class="row">
                        <div class="col-lg-12">
                            <img class="img-responsive " id="logo-indra" src="/integracao/img/iconemod4b.png" alt="logo">
