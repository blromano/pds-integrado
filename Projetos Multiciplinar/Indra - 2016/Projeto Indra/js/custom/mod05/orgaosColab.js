$(document).ready(function() {
            ...
            email: {
                ...
                validators: {
                    ...
                    remote: {
                        ...
                        url: '../../class/mod05/orgaosColab/checarEmailOrgExiste.php',
                        type: 'POST',
                        delay: 500
                    }
                }
            ...
            email: {
                ...
                validators: {
                    ...
                    remote: {
                        ...
                        url: '../../class/mod05/orgaosColab/checarEmailOrgExisteEditar.php',
                        type: 'POST',
                        delay: 500
                    }
                }
    ...
    function listarOrgs() {
        $.ajax({
            dataType: 'json',
            url: '../../class/mod05/orgaosColab/listarOrgs.php',
    ...
    $('#cadastrar-sim').click(function() {
        ...
        if ($('#formCriar').data('formValidation').isValid()) {
            $.ajax({
                method: 'POST',
                url: '../../class/mod05/orgaosColab/createOrgs.php',
                data: org,
                success: function(data) {
        ...
        $('#editar-sim').click(function() {
            if (x) {
                ...
                if($('#formEditar').data('formValidation').isValid() || $('#formEditar').data('formValidation').isValid() == null) {
                    $.ajax({
                        method: 'POST',
                        url: '../../class/mod05/orgaosColab/editarOrgs.php',
                        data: org,
                        success: function(data) {
                            if (data) {
    ...
    $('#list-orgs tbody').on('click', 'button.btn-deletar', function() {
        ...
        $('#deletar-sim').click(function() {
            if (x) {
                $.ajax({
                    type: 'POST',
                    url: '../../class/mod05/orgaosColab/deletarOrgs.php',
                    data: {
                        id: id
                    },
                    success: function(data) {
