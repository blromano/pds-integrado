$(document).ready(function() {
		...
		columns: [
    {
      ...
      className: 'id texto-resumido'
    },
	{
      
      className: 'cidade texto-resumido'
    },
	{
      
      className: 'estado texto-resumido'
    },
	{
      
      className: 'localizacao texto-resumido'
    },
	{
      
      className: 'descricao texto-resumido'
    }
  ]
});
    ...
    //$('#form-cadastrar-pcd').formValidation(options);
        $('#form-cadastrar-pcd').data('formValidation').validate();
            ...
            if($('#form-cadastrar-pcd').data('formValidation').isValid()){
                ...
                $.ajax({
                    url: "../../class/mod02/cadastrarPCD.php",
                    type: "POST",
                    dataType: "JSON",
		...
		$("#input-ok-excluir-pcd").click(function(){
			$("#excluir-pcd").modal('toggle');
...
$('#lista-pcd tbody').on('click', '.btn-excluir', function(){
$('#excluir-pcd').trigger('next.m.1');
        ...
        $("#input-sim-excluir-modal").click(function() {
				...
				$.ajax({
					url: "../../class/mod02/excluirPCD.php",
                    type: "POST",
                    dataType: "JSON",
                    data: 'id='+id,					
					success: function (data){	
