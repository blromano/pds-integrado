...
class UsuarioLogin {
     ...
     */
    public function __construct($id, $nome, $senha, $dataNascimento, $email, $numeroResidencia, $rua, $estado, $cidade, $statusAtivacao, $dataAtivacao, $NivelAcesso, $codigoAtivacao, $dataRecuperacaoSenha, $cep, $complemento)
    {
        $this->id = $id;
        $this->nome = $nome;
        $this->senha = $senha;
