...
include_once "../../modelo/mod01/Feedback.php";
echo "teste";
echo 	$_POST["ide"];
$id = $_POST["ide"];
...
$lista = $feedback->MostrarMensagem($id);
$teste = $feedback->listar();
...
<head>
    ...
    <link href="../../css/custom/mod01/style.css" rel="stylesheet" type="text/css"/>
        ...
        <body id="page-top" class="index">
            ...
            <!-- About Section -->
            <section id="contact">
            	<form class="formEmailFeedback" action="../../class/mod01/enviarEmailFeedBack.php" method="post" id="formEmail">
                   <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="USU_ID" value="<?php echo $lista['USU_ID']?>">
                ...
                <input  class="form-control" rows="5" style="width: 100%" name = "FEE_MENSAGEM" value = "<?php echo $lista['FEE_MENSAGEM'];  ?>">
                <br>  <br>  <br>
                <label for="comment">Resposta:</label>
                <textarea id="comment" class="form-control" rows="5" style="width: 100%" name = "resposta"></textarea>
                <br>  <br>  <br>
                <input  type="submit" role="button" value="Responder" class="btn btn-primary" ></input>
        ...
        <script src="../../js/custon/mod01/tabela.js"></script>
<!--         <script src="js/dataTables.editor.min.js"></script> -->
        ...
        <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
                <script src="../../js/custon/mod01/classie.js"></script>
        <script src="../../js/custon/mod01/cbpAnimatedHeader.js"></script>
