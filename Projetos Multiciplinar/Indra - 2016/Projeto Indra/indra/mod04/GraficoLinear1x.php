<?php
include '../../dao/mod04/GraficoDAO.php';
            ...
            <div class="container">
                <div class="box">
                    ...
                    <div name="NovoGraficoLinha" id="NovoGraficoLinha">                    
                        <form method="GET" action="GraficoLinear1x.php" id="FormularioNovoGraficoLinha" name="FormularioNovoGraficoLinha">
                            ...
                            <a href="GraficoLinear1x.php?id=<?php echo $id; ?>" class="btn btn-primary btn-table">Limpar</a></td>
