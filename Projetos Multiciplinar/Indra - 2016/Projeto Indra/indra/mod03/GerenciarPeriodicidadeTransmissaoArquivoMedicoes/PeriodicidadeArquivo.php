...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Gerenciamento de Periodicidade de Transimissão do Arquivo da PCD</title>
    ...
    <body id="page-top" class="index">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Alterar Periodicidade de Transmissão</h4>
                    </div>
        ...
        <div class="modal fade" id="modal-edit2" role="dialog">
            <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Criar Periodicidade de Transmissão</h4>
                    </div>
                    <div id="form-atualizar2">
        ...
        <div class="modal fade" id="modal-exc" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Excluir Periodicidade de Transmissão</h4>
                    </div>
                    <div id="form-excluir">
        ...
        <section id="contact">
            ...
            <div class="container">
                ...
                <div class="panel panel-body">
                    ...
                    <h2>gerenciamento de Periodicidade de Transmissão do Arquivo da PCD</h2>
                    <br /><br />
                    <table id="periodicidade-arquivos" class="table table-condensed">
                        <thead>
                            <tr bgcolor="#3a4857">
                                <th width="14%">Codigo da PCD</th>
                                <th width="14%">Latitude</th>
                                <th width="14%">Longitude</th>                                
                                <th width="14%">Status de Funcionamento</th>
                                <th width="14%">Periodicidade Arquivos</th>
                                <th width="15%"></th>
                                <th width="15%"></th>
                            </tr>
                        </thead>
        ...
        <!-- js sensores -->
        <script src="../../../js/custom/mod03/arquivoAJAX.js"></script> 
