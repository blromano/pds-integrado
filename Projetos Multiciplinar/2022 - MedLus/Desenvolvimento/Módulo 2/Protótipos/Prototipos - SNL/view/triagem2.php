...
<section class="d-flex flex-column align-items-center">
        <section class="bg-white mt-5 mb-5 listagem d-flex align-items-center flex-column px-5 col-md-6 col-sm-12 col-lg-3">
            ...
            <div class="d-flex flex-column align-items-center w-100">
                <img class="rounded-circle mt-5" width="150px" src="../assets/img/logo.png" class="font-weight-bold"> <h3> Triagem </h3>
            </div>
            </br>
            <h4 >Marque todas as afirmativas abaixo que se aplicam a você</h4>
                        <div class="container mt-1">
                         ...
                         <button type="submit" href="#" class="btn btn-sm btn-primary">Voltar</button>
                         <button type="submit" href="#" class="btn btn-sm btn-primary">Cancelar</button>
                         <button type="submit" href="#" class="btn btn-sm btn-primary">Próximo</button>
            </div>
        </section>
</section>
