...
<section class="container mt-5">
    ...
    <button type="button" class="btn btn-primary"data-bs-dismiss="modal">Histórico de Autorizações</button>
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th scope="col">Data/Horário Marcado</th>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <li class="list-group-item">
                                        <img src="https://conteudo.imguol.com.br/c/esporte/62/2022/04/23/neymar-em-acao-durante-psg-x-lens-jogo-valido-pelo-campeonato-frances-1650745590042_v2_1x1.jpg" width="350" height="300"> 
                                    </li>
                                    </ul>
                                </div>
                            </div>
