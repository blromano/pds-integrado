<div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Gerenciamento de Vacinações</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-2">
                  <a href="/md5/cadastrarVacinacao" style="width:100%" class="btn btn-primary btn-sm">Inserir Vacinação</a>
                </div>
              </div>
            </div> 
          <div class="card-body">
              ...
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>0,25</td>
                    <td>-</td>
                    <td><a href="/md5/editarVacinacao" class="btn btn-primary btn-sm">Editar</a></td></td>
                  </tr>
                </tbody>
              </table>
            </div>
