...
if(document.dados.tx_mensagem.value=="" || document.dados.tx_mensagem.value.length < 8)
{
...
return true;
  ...
  <table width="588" border="0" align="center" >
	<tr>
      <td><font face="Verdana, Arial, Helvetica, sans-serif"><font size="4">Mensagem<strong>:</strong></font></font></td>
      <td rowspan="2"><font size="30">
        <textarea name="tx_mensagem" cols="50" rows="8" class="formbutton" id="tx_mensagem" input ></textarea>
      </font></td>
    </tr>
	
	<P> Status de alimentação: </P>
	<select name="estados-brasil">
	<option value="AC">Pouca aceitação</option>
	<option value="AC">Média aceitação</option>
	<option value="AL">Boa aceitação</option>
	<option value="AC">Não aceitou</option>
