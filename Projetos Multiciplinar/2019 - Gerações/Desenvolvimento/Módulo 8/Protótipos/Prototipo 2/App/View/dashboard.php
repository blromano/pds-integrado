...
<html lang="en">
    ...
    <head>
        ...
        <link href="../../resources/CSS/cssmod8.css" rel="stylesheet" type="text/css"/>
    </head>
        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav bg-dark">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                        <a class="dropdown-item" href="">Exercícios Físicos</a>
                        <a class="dropdown-item" href="">Atividades Recreativas</a>
                        <a class="dropdown-item" href="">Treinamentos</a>
                        <a class="dropdown-item" href="">Planos Mensais</a>
                    </div>
                </li>
                <li class="nav-item dropdown active">
                    <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                        <a class="dropdown-item" href="/md8/cadastro_Tarefas">Cadastro de Tarefas</a>
                        <a class="dropdown-item" href="/md8/controle_Doacoes">Controle de Doações</a>
                        <a class="dropdown-item" href="/md8/ficha_Funcionario">Ficha de Funcionários</a>
                        <a class="dropdown-item" href="/md8/fluxo_Caixa">Fluxo de Caixa</a>
                        <a class="dropdown-item" href="/md8/lista_Funcionarios">Lista de Funcionários</a>
                        <a class="dropdown-item" href="/md8/lista_Tarefas">Lista de Tarefas</a>
                        <a class="dropdown-item" href="/md8/orcamento_Instituicao">Orçamento da Instituição</a>
                        <a class="dropdown-item" href="/md8/pagamentos_Paciente">Pagamentos de Pacientes</a>
                    </div>
                </li>
                <li class="nav-item dropdown active">
                    <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
