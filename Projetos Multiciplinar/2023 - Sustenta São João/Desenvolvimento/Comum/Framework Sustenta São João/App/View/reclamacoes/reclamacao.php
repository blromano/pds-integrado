  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form action="/dashboard/inserirReclamacao" method="POST" class="form_j" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea type="text" style="border: 1px solid #E3E3E3; border-radius: 30px;" class="form-control" name="REC_DESCRICAO" id="REC_DESCRICAO" placeholder="Descreva aqui o seu problema" required></textarea>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select name="FK_SETORES_SET_ID" class="form-control text_j">
            ...
            <div>
              ...
              <input type="file" class="form-control text_j" id="REC_ANEXO" name="REC_ANEXO">
