<html>
    ...
    <body>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="areaDePesquisa">
                                ...
                                <p>
                                Pesquisar:<input style='margin-left:10px' type="text" name="pesquisarSetore">
                                ...
                                <form>
                                    ...
                                    <ul class="elementos">
                                        ...
                                        <li class="itemLista2">
                                            ...
                                            <button class="bnt-engrenagem" id="abrirAlertEditar"><i class="fas fa-cog"></i></button>                            
                                        </li>                                
                                    </ul>                                             
                                </form>                                                                                         
                            </div>
                    ...
                    <form class="formulario">
                        <fieldset>
                            ...
                            <div class="elementosLabel">
                                ...
                                <input type="text" value="20/08/2004" >
                            </div>
                            <div class="elementosLabel">
                                <label>Setor que é responsável</label>
                                <input type="text" value="Descarte de Resíduos" >
                            </div>
        ...
        <script>
            const botaoAbrir = document.getElementById('abrirAlertEditar');
