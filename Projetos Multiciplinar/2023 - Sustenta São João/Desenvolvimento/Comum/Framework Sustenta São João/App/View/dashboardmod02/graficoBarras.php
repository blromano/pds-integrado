          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                ...
                <h4 class="card-title">Respostas negativas</h4>
                <div class="dropdown">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                ...
                <h4 class="card-title">Respostas Positivas</h4>
                <div class="dropdown">
                  <button type="button" class="btn btn-round btn-outline-default dropdown-toggle btn-simple btn-icon no-caret" data-toggle="dropdown">
                    <i class="now-ui-icons loader_gear"></i>
                  </button>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                ...
                <h4 class="card-title">Performance do Setor</h4>
              </div>
              <div class="card-body">
                <div class="chart-area">
                      ...
                      <div class="form-group">
                        <label class="text-success title">Setor</label>
                            ...
                            <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                                ...
                                <label class="text-success title" for="example-2">Data final</label>    
                                <input placeholder="Select date" type="date" id="example-2" class="form-control">
                            </div>
