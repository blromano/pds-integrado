...
if (isset($_SESSION['USU_EMAIL'])) {
	...
	if ($tipo == 'est') {
		...
		foreach ($est as $linha) {
			...
			// header('location:../../idESTABELECIMENTO='.$linha['EST_ID'].'.php');
		}
		# code...
			// echo "ID ESTABELECIMENTOS: ".$_SESSION['EST_ID'];
// select * from estabelecimentos where EST_ID=999;
		header('Location: est_boas-vindas.php');
		}elseif ($tipo == 'adm') {
		# code...
			header('Location: admin.php');
		}else{
		// REDIRECIONAMENTO PAGINA ALVO
		}	
	}else{
					...
					<div id="itema" class="item active" style="background-image: url(images/slider/1.jpg); background-size:cover; back:no repeat; background-attachment:fixed;height:100vh;background-position:center center;">
						...
						<div class="row" style="padding-top: 10px">
							<div class="container">
								...
								<div class="col-md-6">
									<span class="pull-right">
										<div class="dropdown">
											<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION['USU_EMAIL'];?>
												<span class="caret"></span></button>
												<ul class="dropdown-menu">
													<li><a href="usu_editarInformacoesUsuario.php"><span class="glyphicon glyphicon-pencil"></span> Editar Informações</a></li>
												...
												<i><a href="usu_chatUsuario.php" style="font-size:28px; margin-left:45px" class="fa fa-comments" aria-hidden="true"></a></i>												
											</div>
										</span>
									</div>
								</div>
							...
							<div class="caption" style="margin-left:10px;">
								<!-- <div class="container">-->
									<h1 class="animated fadeInLeftBig">Seja Bem Vindo </h1>
									<span class="destinations-form animated fadeInLeftBig">
										<div class="input-line">
											<!-- encontreempresa -->
											<form style="color: black;" action='rec_estabelecimento.php' method='get'>
												<p><label></label><input type='text' id='EST_NOME' name='EST_NOME' value='' class="form-input check-value auto" placeholder="Buscar"></p>
												<button type="submit" name="destination-submit" style="margin-top: 0%; margin-left:1%;" class="form-submit btn btn-special" 
												onclick="location.href='rec_estabelecimento.php'".click()><i class="fa fa-search fa-2x "></i> </button>
					...
					<div class="container">
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="index.php">
								<h1 style="margin-left:10px;"><img class="img-responsive" src="images/logo.png" alt="logo"></h1>
							</a>
						</div>
...
<div class="menu-list">
	...
	<ul id="menu-content" class="menu-content collapse out">
		...
		<li data-toggle="collapse" data-target="#gerenciar" class="collapsed">
			<a href="#"><i class="fa fa-caret-down fa-lg"></i> Gerenciar <i class="fa fa-align-right fa-lg btn pull-right" style="margin-top:5px; margin-right:4px;"></i></a>
		</li>
		<ul class="sub-menu collapse" id="gerenciar">
			<li onclick="location.href='rec_gerenciar.php'".click()>Minhas reclamações</li>
			<li onclick="location.href='rec_gerenciar.php'".click()>Minhas avaliações</li>                  
		</ul>
	</ul>
</div>
 ...
 <section id="serviços" style="margin-bottom: 5%;margin-left:15px;">
         <div class="container">
            ...
            <div class="text-center our-services">
               <div class="row">
                  <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="750ms" href="rec_pesquisar_estabelecimento.php" onclick="myhref('rec_pesquisar_estabelecimento.php');">
                  ...
                  <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="750ms" href="ava_pesquisar_estabelecimento.php" onclick="myhref('ava_pesquisar_estabelecimento.php');">
                     <div class="service-icon">
...
-->
      <div class="modal-footer">
		...
		<!--mapa-->
	<section id="mapa" style="margin-left:15px;">
	</br></br></br></br></br>
        <!-- Hiring -->
...
-->	
 ...
 <div class="row">
  ...
  <div class='row'>
   ...
   <!-- Portfolio Grid Section -->
   <section id="semana" style="margin-left:15px;">
    <section id="portfolio" class="bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
