    ...
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div id="itema" class="item active" style="background-image: url(images/slider/1.jpg); background-size:cover; back:no repeat; background-attachment:fixed;height:100vh;background-position:center center;">
			  ...
			  <div class="container">
				  ...
				  <div class="col-md-6" >
					  <span class="pull-right">
							<div class="dropdown">
							  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION['EST_NOME_FANTASIA'] ?>
							  <span class="caret"></span></button>
							  <ul class="dropdown-menu">
								<li><a href="est_perfil.php"><span class="glyphicon glyphicon-pencil"></span> Editar Perfil</a></li>
								<li><a href="est_gerenciar-reclamacao-nao-atendida.php"><span class="glyphicon glyphicon-comment"></span> Reclamações</a></li>
								<li><a href="php/mod01/sair.php"><span class="glyphicon glyphicon-off"></span> Sair</a></li>
							  </ul>
							  <i style="font-size:28px; margin-left:45px" class="fa fa-comments" aria-hidden="true"></i>
							</div>
					  </span>	  
				  </div>
			  </div>
		 ...
		 <div class="caption">
            <h1 class="animated fadeInLeftBig" >Seja Bem Vindo </br></h1>
            ...
            <p id="textobloco1" class="animated fadeInRightBig"><br>VEJA A REPUTAÇÃO DOS ESTABELECIMENTOS</p>
          </div>
        </div>
        </div>
	   </div>
		  ...
		  <div class="container">
			...
			<div class="collapse navbar-collapse">
			  <ul class="nav navbar-nav navbar-right">                 
				...
				<li class="scroll"><a href="#about-us2">Depoimentos</a></li> 
						...
						<div class="menu-list">
							...
							<ul id="menu-content" class="menu-content collapse out">
								...
								<li data-toggle="collapse" data-target="#new" class="collapsed">
									<a href="index.php"><i class="fa fa-caret-down fa-lg"></i> Sair <i class="fa fa-file-text fa-lg btn pull-right" style="margin-top:5px; margin-right:2px;"></i></a>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="row">
				  <div class="col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
					<div class="service-icon">
					  <a style="color: white;"href="../../reclamar.html"><i  class="fa fa-comments"></i></a>
					</div>
				  ...
				  <div class="col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="450ms">
					...
					<div class="service-info">
					  <h3>Avisar ao estabelecimento</h3>
					  <p>Informar o estabelecimento sobre a reclamação criada à seu respeito</p>
					</div>
				  </div>
				  ...
				  <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="650ms">
					<div class="service-icon">
					  <i><span class="glyphicon glyphicon-map-marker"></span></i>
					</div>
					<div class="service-info">
				  ...
				  <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="750ms" data-toggle="modal" data-target="#myModal">
					<div class="service-icon">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<p class="mapaletra wow fadeInUp" style="text-align: center;">
								<button class="buttonmap" type="submit" onclick="location.href='file:///C:/Users/aluno/Desktop/SVn/trunk/desenvolvimento/comum/NAO%20MECHER%20POR%20OBZEKIO/mapa.html'".click();>Ver Empresas</button>
							</p>
						</div>
					</div>
				</div>
