<?php
	include 'controle/GerenciarDAO.php';
	$ReclamacaoDAO = new ReclamacaoDAO;
	$usu_nome = $ReclamacaoDAO->usuarioNome();
	$con_id = $ReclamacaoDAO->consumidorID();
	include_once("rec_conexao.php");
	$_SESSION["rec_id"] = $con_id; 
?>
...
<input type="hidden" name="link" value="index.php">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right" style="height: 80px;">   
			<li class="scroll active" style="cursor: pointer;"><a href="#main-wrapper">Gerenciar Atividades</a></li>
            <li class="scroll" style="cursor: pointer;"><a onclick="redirect()">Estabelecimento</a></li>
           <li class="scroll" style="cursor: pointer;"><a href="contato.php"><?php echo $usu_nome ?></a></li>
          </ul>
        </div>
      </div>
    </div><!--/#main-nav-->
