            ...
            <div class = "modal-dialog" >
                <div class = "modal-content" >
                    ...
                    <div class = "modal-body" >
                        <form action = "../../MVC/visao/TiposEstabelecimento/update_TiposEstabelecimento.php" method = "post" >
                            <ul class = "list-group" >
        ...
        <div id = "remover" class = "modal fade" role = "dialog" >
            <div class = "modal-dialog" >
                <div class = "modal-content" >
                    ...
                    <div class = "modal-body" >
                        <form action = "../../MVC/visao/TiposEstabelecimento/deleta_TiposEstabelecimento.php" method = "post" >
                            <ul class = "list-group" >
        ...
        <div id = "add" class = "modal fade" role = "dialog">
            <div class = "modal-dialog" >
                <div class = "modal-content" >
                    ...
                    <div class = "modal-body" >
                        <form action = "../../MVC/visao/TiposEstabelecimento/add_TiposEstabelecimento.php" method = "post" >
