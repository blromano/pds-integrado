...
<div class="dropdown">
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> Subway
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    <li><a href="mod03-perfil.html"><span class="glyphicon glyphicon-pencil"></span> Editar Perfil</a></li>
	<li><a href="mod03-gerenciar-reclamacao-nao-atendida.html"><span class="glyphicon glyphicon-comment"></span> Reclamações</a></li>
  ...
  <i style="font-size:28px; margin-left:45px" class="fa fa-comments" aria-hidden="true"></i>
		 ...
		 <!-- <div class="container">-->
            ...
            <h1 class="animated fadeInLeftBig" >Seja Bem Vindo </br><span>"Subway"</span></h1>
  ...
  <section id="serviços" style="margin-bottom: 5%;">
	...
	</section> <!--FIM DO SECTION SERVIÇOS-->
