<?php
	...
	public function __construct()
    {
		...
		$this->tabela = "cadastrousuarios";
    }
	
	public function inserirUsuario($usuario)
	{
		$this->usuario = $usuario;		
		$this->sql="insert into $this->tabela (nome, sobrenome,cpf,cep,senha,confirmar_senha,email,rua,bairro,numero,complemento,estado,cidade,telefone1,telefone2,data_nascimento,foto_perfil) values (:nome,:sobrenome,:cpf,:cep,:senha,:confirmar_senha,:email,:rua,:bairro,:numero,:complemento,:estado,:cidade,:telefone1,:telefone2,:data_nascimento,:foto_perfil)";		
	...
	public function logarUsuario($usuario){
		$this->usuario = $usuario;		
		$this->sql="SELECT * FROM cadastrousuarios WHERE email = :email AND senha = :senha";
		$this->resultado = $this->conexao->prepare($this->sql);
		...
		*/	
		...
		//Redireciona para a página de autenticação
			...
			header('location:mod01-loginUsuario.php');
