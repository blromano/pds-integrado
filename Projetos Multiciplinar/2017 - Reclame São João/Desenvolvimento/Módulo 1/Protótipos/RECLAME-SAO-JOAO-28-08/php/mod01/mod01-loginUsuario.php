  ...
  <!-- Modal escolher forma de cadastro (usuário / estabelecimento)-->
	...
	-->
		  <div class="modal-footer" align="center">
						<button class="btn btn-default" type="submit" onclick="location.href='mod01-cadastroUsuario.php'".click();>Usuário</button>
        ...
        <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
		  ...
		  <p class="text-center text-danger">
            ...
            <div class="col-sm-6" style="width: 40%; margin-right: 30%; margin-left: 30%;" >
              <form id="main-login-form" name="login-form" action="../../MVC/visao/Usuarios/loginUsuario.php" method="POST"  ;
				...
				<p><a class="recuperarSenha" href="mod01-emailRecuperarSenha.php"> Clique aqui </a>para recuperar sua senha</p>                
