            ...
            <div class="container" role="main" style="height: 100%;width: 100%;  min-height: 100%;">
                ...
                <div class="tabcontent p-md-8">  <br>
                    ...
                    <div class="row">
                        <div class="col">
                            <h4>Nome</h4>
                            <input type="text" class="form-control" placeholder="Rogério" id="genero" disabled>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div id="treino">
                        ...
                        <div style="text-align: center;">
                            <button type="button" class="btn btn-primary btn-lg" onclick="habilitar()">Editar dados</button>
                            <button type="button" class="btn btn-danger btn-lg" onclick="finalizar()">Confirmar Dados</button>
                            <button type="button" class="btn btn-info btn-lg">Enviar Ficha de Treinamento</button>
                        </div>
                        <br>
                        <br>
                    </div>
