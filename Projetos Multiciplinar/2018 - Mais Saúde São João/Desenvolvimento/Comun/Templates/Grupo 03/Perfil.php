    ...
    <div class="w3-col m10" >
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Emprego:Educador Fisico</p>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Ensino:Ensino Médio Completo</p>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Idade:25</p>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> RG: 5642584-9</p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> Sao Joao, BR</p>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Descrição: Sou uma pessoa especial a procura da forma ideal.</p>
