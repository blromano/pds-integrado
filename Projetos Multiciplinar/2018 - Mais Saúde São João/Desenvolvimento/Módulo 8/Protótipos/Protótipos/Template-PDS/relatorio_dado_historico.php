   ...
   ================================================== -->
    ...
    <body style="background-color:white">
        ...
        <div class="container" role="main" style="height: 100%;width: 100%; padding:5%; float:left; min-height: 100%" >
            ...
            <h1 style='color:#104999'>Relatórios de Dados Históricos</h1>
            </div>
        
            <br><br>
            <a href="historico_consumo.php"><button class="btn btn-primary" resposive>Exibir Histórico de Consumo de Calorias e Nutrientes</button></a><br>
            <br> <a href="historico_peso.php"><button class="btn btn-primary" responsive>Exibir histórico de peso</button></a> <br>
            <br><br>
            <div style="width: 100%;height: 50%;text-align:end;clear:both">
                <a href="diario_bordo.php"><button type="button" class="btn btn-info">Voltar</button></a>
            </div>
        </div>
