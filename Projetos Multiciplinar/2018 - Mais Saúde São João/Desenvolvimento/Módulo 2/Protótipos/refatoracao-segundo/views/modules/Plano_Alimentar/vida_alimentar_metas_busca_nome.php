                ...
                <div class="row">
                    <div class="container text-center p-5">
                     ...
                     <div name="busca_usuario">
                           ...
                           <form action="?mod=palimentar&sub=vida_alimentar_metas_busca_nome" method="post">
                            ...
                            <table class="table">
                             ...
                             <?php    foreach ($res as $row) { ?>
                                    ...
                                    <tr scope="row">
                                        ...
                                        <td> 
                                          <form action="controllers/modules/Plano_Alimentar/envia_vida_alimentar.php" method="POST" >
