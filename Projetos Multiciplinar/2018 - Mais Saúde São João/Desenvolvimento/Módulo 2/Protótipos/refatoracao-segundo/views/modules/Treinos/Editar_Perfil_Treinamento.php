<html lang="pt-br">
    ...
    <!--Dados do paciente ---> 
        <div class="container">
            <div class="container">
            <br><br>
            <h1 class="text-center center " >Editar do perfil de treinamento</h1>
            <br><br>
            <form class="form text-center" method="post"  action="test.php">
                <div id="conteudocadastro">
                    <!-- NOME DO USUÁRIO-->                   
                    <div class="row form-group col-md-6">
                        <div class="col">
                            <label>Nome do usuário:</label>
                            <input type="text" class="form-control" value="Nome do individuo" id="nomeusuario" disabled>
                        </div>    
                    </div>
                ...
                <div>    
                    <br>
                    <input class=" btn-primary" type="submit" id="botaoeditarperfil" name="botao" value="Editar"></br>
                </div>
                <br><br>
            </form>    
        </div>    
