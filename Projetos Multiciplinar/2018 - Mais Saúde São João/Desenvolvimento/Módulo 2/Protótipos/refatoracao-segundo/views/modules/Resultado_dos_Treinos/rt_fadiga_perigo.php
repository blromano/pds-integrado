            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <img src="fadigaPerigo.png">
                        <h1 class="modal-title" id="myModalLabel"> Perigo!</h1>
                        Você está sofrendo de fadiga muscular! Você exercitou o mesmo grupo muscular 3 dias seguidos, é
                        extremamente desaconselhável continuar o treinamento sem repouso pois há risco de lesão.
                        <br>Músculo(s) afetado(s) : Bíceps
                    </div>
